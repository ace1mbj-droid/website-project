  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(89),
        ...
        i = s(634);
      const c = JSON.parse(
          '["ace138\\\\.godaddysites\\\\.com(?:/.*)?/ola/services/.*","ace138\\\\.godaddysites\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://e889fc1c-062b-4df4-8ad6-5c678ede1e6f\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]'
        ).map((e) => new RegExp(e)),
        o = JSON.parse(
          '["ace138\\\\.godaddysites\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/e889fc1c-062b-4df4-8ad6-5c678ede1e6f/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/e889fc1c-062b-4df4-8ad6-5c678ede1e6f/feed"]'
        ).map((e) => new RegExp(e)),
        h = JSON.parse(
          '["/our-journey","/about-us","/","/contact-us","/ace-gallery"]'
        ).map((e) => ({ url: e, revision: "1760543846162" }));
      self.addEventListener("activate", function (e) {
        e.waitUntil(
          caches.keys().then(function (e) {
            return Promise.all(
              e
                .filter((e) => e.startsWith("ace138.godaddysites.com-"))
