...
_trfd.push({
  ap: "IPv2",
  websiteId: "e889fc1c-062b-4df4-8ad6-5c678ede1e6f",
  "tccl.baseHost": "secureserver.net",
  pd: "2025-10-15T15:57:25.246Z",
  "meta.numWidgets": 4,
  "meta.theme": "layout13",
...
var radpack = (function () {
  ...
  const _ = async (t, e) => {
    const r = await f(t),
      { fetch: i, parse: h = v, register: a = _ } = e;
    return (
      await s.all(
        r.map(async (t) => {
          const s = h(t, e),
  ...
  var m = (t, s = {}) => t.replace(g, (t, e) => (e in s ? s[e] : t)),
    b = () => {};
  const E = [u, o, c];
  class C extends class extends Function {
    constructor(t) {
    ...
    async urls(t) {
      return await this.register(), this.m(this.$(t));
    }
    register(t, e) {
      const r = this.l.catch(b);
      return t
        ? (this.l = s.all([this.C(t, e), this.R(), r]).then(([t]) => {
            this.U(t, e);
          }))
        : r;
    }
    ...
    k(t) {
      return this.q(this.t && t.startsWith("~/") ? this.t + t.substr(1) : t);
    }
    J(t) {
      return !!t && this.q(t);
    }
    ...
    j(t, s) {
      const e = v(t, s);
      return e && e.url && (e.url = this.J(e.url)), e;
    }
    $(t) {
      t = this.k(t);
    ...
    _(t) {
      return d(t) ? s.all(t.map(this._, this)) : this.P(this.$(t));
    }
    R() {
      return s.all(
    ...
    P(t) {
      ...
      return this.S(e, () => {
        ...
        return (
          r
            ? ((i = t.data.statics), t.url !== r && this.o.set(this.k(t.id), t))
            : this.A(t).forEach((t) => {
                t.url && i.push(t.id);
              }),
          s.all([r && this.T(t, e), i.length && this._(i)])
        );
      });
    }
    D(t, s) {
      const e = this.p(t);
      return this.S(e, () => this.F(e, s), "fetch");
    }
    C(t, s) {
      return _(t, { ...s, parse: this.j.bind(this), fetch: this.D.bind(this) });
    }
    F() {}
    T() {}
    I(t) {
  ...
  const R = new (class extends C {
    ...
    U(t) {
      t.forEach((t) => this.I(this.O(t)));
    }
  })();
  return (globalThis.define = R.define.bind(R)), R;
})();
