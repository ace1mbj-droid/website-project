define(
  "@widget/LAYOUT/bs-layout13-Theme-publish-Theme-a148e55d.js",
  [
    "exports",
    ...
    "~/c/bs-index",
    "~/c/bs-overlayTypes",
    "~/c/bs-imageToHeaderTreatments",
  ],
  function (e, t, r, a, o, n, i, s, l, g) {
    "use strict";
    const {
        colorPackCategories: { NEUTRAL: d, ACCENT: u },
        buttons: c,
        contentPositions: { CENTER: m },
      ...
      x = {
        [l.F]: "category-overlay",
        [l.b]: "category-overlay",
        [l.c]: "category-solid",
        [l.B]: "category-overlay",
        [l.L]: "category-overlay",
        [l.W]: "category-solid",
        [l.d]: "category-overlay",
      },
      I = l.F;
    var w = {
      id: "layout13",
      name: "modern",
      packs: { color: "005", font: "league-spartan" },
      logo: { font: "primary" },
      packCategories: { color: u, paintJob: C },
    ...
    class L extends r.D {
        ...
        return "HEADER" === e
          ? {
              ...
              headerTreatmentsConfig: {
                ...
                ...w.headerTreatmentsConfig,
              },
              enableVideoOverlaySlider: !0,
            }
          : { ...r, enableCircularImage: a };
      }
      constructor() {
        super(),
            ...
            typographyOverrides: {
              ...
              NavAlpha: {
                style: {
                  ...
                  ":hover": { color: "highContrast", opacity: "50%" },
      ...
      Heading(e) {
        const { tag: t } = e,
          { widgetType: r, widgetPreset: a } = this.base;
          ...
          this.merge(
            {
              style: {
                ...
                paddingTop: 0,
                "@md": { marginBottom: "xxlarge", maxWidth: "50%" },
              },
            },
            e
          )
      ...
      SubTagline(e) {
        return super.SubTagline(
          this.merge({ style: { lineHeight: "1.5", maxWidth: "100%" } }, e)
        );
      }
      Icon(e) {
        return super.Icon(this.merge({ iconPack: { ...r.f, ...n.s } }, e));
      }
      Loader(e) {
        return i.a.apply(this, [e]);
      }
      SectionHeading(e) {
        const t = this.base,
          r = this.merge({}, a.s(t), a.b(t), a.c(t), a.a(t));
          ...
          this.merge(
            {
              style: {
                textAlign: "center",
                marginLeft: "auto",
                "@md": { textAlign: "center", marginLeft: "auto" },
              },
              sectionHeadingHR: T,
              featured: !1,
            },
      ...
      Pipe(e) {
        return super.Pipe(this.merge({ style: { height: "1em" } }, e));
      }
      ...
      HeaderMediaFillBackground(e) {
        return this.HeaderMediaBackground(
          this.merge({ style: { justifyContent: "space-between" } }, e)
        );
      }
      ...
      PromoBanner(e) {
        return super.PromoBanner(
          this.merge({ style: { position: "relative", zIndex: 1 } }, e)
        );
      }
      Input(e) {
        return super.Input(
      ...
      NavigationDrawerInputSearch(e) {
        return super.NavigationDrawerInputSearch(
          this.merge({ ...this.sharedInputStyles }, e, {
            style: {
      ...
      InputFloatLabelLabel(e) {
        return super.InputFloatLabelLabel(
          this.merge({ style: { left: "16px", top: "33%" } }, e)
        );
      }
      InputTextArea(e) {
        return super.InputTextArea(this.merge({ rows: 6 }, e));
      }
      InputSelect(e) {
        return super.InputSelect(this.merge({ ...this.sharedInputStyles }, e));
      }
      ...
      HeadingMajor(e) {
        return super.HeadingMajor(this.merge({ featured: !0 }, e));
      }
      PriceMajor(e) {
        return super.PriceMajor(this.merge({ typography: "HeadingDelta" }, e));
      }
      SlideshowArrows(e) {
      ...
      NavigationDrawerLink(e) {
        return super.NavigationDrawerLink(
          this.merge({ style: { paddingRight: "xxsmall" } }, e)
        );
      }
      NavigationDrawerSubLink(e) {
        return super.NavigationDrawerSubLink(
          this.merge({ style: { paddingLeft: "medium" } }, e)
        );
      }
      IconSearch(e) {
        return super.IconSearch(
          this.merge({ style: { color: "highContrast" } }, e)
        );
      }
      Membership(e) {
        return super.Membership(
          this.merge({ style: { marginTop: "medium" } }, e)
        );
      }
      FormSearch(e) {
