define(
  "@widget/LAYOUT/bs-Hamburger-Component-00199ec8.js",
  [
    "exports",
  ...
  function (e, t, o, s, n, i) {
    "use strict";
    const { PUBLISH: a } = (global.Core || guac["@wsb/guac-widget-core"])
    ...
    class r extends (global.React || guac.react).Component {
      constructor() {
        super(...arguments),
          ...
          t._(this, "setNavigationOffset", () => {
            ...
            this.toggleTarget &&
              void 0 !== this.offsetLeft &&
              (this.toggleTarget.style.cssText = `\n          visibility: visible;\n          transform: ${
                e ? `translateX(-${this.offsetLeft}px)` : `translateX(${i.N})`
              };\n        `);
          }),
          ...
          (this.handleChange = (global._ || guac.lodash).throttle(
      ...
      componentDidUpdate(e, t) {
        let { open: o } = t;
        const { isMobile: s } = this.props;
        o !== this.state.open &&
          ("undefined" != typeof window &&
            window.dispatchEvent(
              new Event(
                "NavigationDrawer" + (this.state.open ? "Opened" : "Closed")
              )
            ),
          this.toggleTarget &&
            (this.setNavigationOffset(),
            s &&
              this.props.renderMode === a &&
      ...
      renderIcon() {
        const { icon: e, openIcon: t } = this.props,
          { open: o } = this.state;
        return o && "close" === t
          ...
          : (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Icon
                .Hamburger,
              { icon: o ? t : e, size: n.I, minTarget: !0 }
            );
      }
      render() {
        const e = (global._ || guac.lodash).omit(this.props, [
            "Component",
            "renderMode",
          ]),
          { style: n, staticContent: i = {} } = e;
        return (global.React || guac.react).createElement(
          ...
          t.a({}, e, {
            ...
            style: { border: 0, justifyContent: "flex-start", ...n },
            "data-aid": s.D.HAMBURGER_MENU_LINK,
            "aria-label": i.hamburgerIcon || "Hamburger Site Navigation Icon",
          }),
          this.renderIcon()
        );
      }
