...
class Default extends UX2.Theme {
  ...
  static getWidgetDefaultProps(widgetType) {
    return {
  ...
  // eslint-disable-next-line no-unused-vars
  static getMutatorDefaultProps(widgetType) {
  ...
  SocialLinksNavBarIconSocial() {
    return Elements.SocialLinksNavBarIconSocial.apply(this, arguments);
  }
  ...
  IconTrustedSite() {
    return Elements.IconTrustedSite.apply(this, arguments);
  }
  ...
  NavBarPhone() {
    return Elements.NavBarPhone.apply(this, arguments);
  }
