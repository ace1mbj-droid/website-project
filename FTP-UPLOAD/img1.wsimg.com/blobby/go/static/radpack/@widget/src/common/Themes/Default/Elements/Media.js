...
import { minimalIconMapping } from "../../../Components/Internal/Header/utils/mapPropsToSocialProps";
import * as filledIcons from "../../../IconPacks/humanisticFilled";
import * as socialIconPack from "../../../IconPacks/SocialIcons/minimalSocialIconPack";
  ...
  return this.merge(
    {
      ...
      children: svgPath,
      viewBox:
        iconSizeWidth && iconSizeHeight
          ? `0 0 ${iconSizeWidth} ${iconSizeHeight}`
          : "0 0 24 24",
      fill,
...
export function SocialLinksNavBarIconSocial(props) {
  let { icon } = props;
  icon = minimalIconMapping[icon] || icon;

  props.icon = icon;
  props.iconPack = { ...filledIcons, ...socialIconPack };
...
export function IconTrustedSite(props) {
  const color = this.base.category === "neutral";
