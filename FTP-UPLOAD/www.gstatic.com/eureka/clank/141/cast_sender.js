...
*/
  ...
  var Fa = function (a) {
      ...
      return a.replace(Ea, function (d, e) {
        ...
        if (!h) {
          ...
          if (
            c.nodeType === 1 &&
            ((e = c.tagName), /^(script|style)$/i.test(e))
          )
            throw (
              ((d =
  ...
  chrome.cast.media.T = function (a) {
    this.containerType = a =
      a === void 0 ? chrome.cast.media.U.GENERIC_CONTAINER : a;
  ...
  chrome.cast.media.fa = function () {
    chrome.cast.media.MediaMetadata.call(
      this,
      chrome.cast.media.F.AUDIOBOOK_CHAPTER
    );
    this.images =
      this.subtitle =
      this.bookTitle =
  ...
  chrome.cast.media.h.prototype.queueSetRepeatMode =
    chrome.cast.media.h.prototype.cc;
  ...
  chrome.cast.media.h.prototype.queueUpdateItems =
    chrome.cast.media.h.prototype.dc;
  ...
  chrome.cast.media.h.prototype.queueInsertItems =
    chrome.cast.media.h.prototype.Tb;
  chrome.cast.media.h.prototype.editTracksInfo =
    chrome.cast.media.h.prototype.O;
  ...
  var Wa = function () {
    ...
    $a = function (a, b) {
      ...
      if ((a = a.g[b.sessionId]))
        (b = a.media.indexOf(b)), b != -1 && a.media.splice(b, 1);
    };
  function R() {
    var a = r.navigator;
  ...
  var T = function () {
    ...
    U = function (a) {
      ...
      return (b == "object" && a) || b == "function"
        ? "o" +
            ((Object.prototype.hasOwnProperty.call(a, v) && a[v]) ||
              (a[v] = ++la))
        : b.slice(0, 1) + a;
    };
  f = T.prototype;
  ...
  var V = function () {
    ...
    fb = function (a) {
      var b = new chrome.cast.Error(
        chrome.cast.A.INVALID_PARAMETER,
    ...
    W = function (a, b, c, d) {
      ...
      c &&
        ...
        ((a = a.g),
        (d = new chrome.cast.Error(chrome.cast.A.INVALID_PARAMETER, d)),
        a && a(d));
    };
        ...
        function (d) {
          d.onchange = function () {
            c.g.receiverListener(
              d.value ? chrome.cast.N.AVAILABLE : chrome.cast.N.UNAVAILABLE
            );
          };
          d.onchange();
        },
  ...
  var X = function (a, b) {
    ...
    var e = b.dialRequest;
    e &&
      ((c = e.appName), (d = e.launchParameter) && !d.match(hb) && (d = db(d)));
    var h = [];
    ...
    a.Da(
      ...
      function (m) {
        m.status && m.status.length == 1
          ? e && e(m.status[0])
          : ((m = new chrome.cast.Error(chrome.cast.A.SESSION_ERROR)),
            h && h(m));
      },
      h,
      k
  ...
  f.Ca = function (a) {
    if (a.l) {
      var b =
        a.playerState != chrome.cast.media.B.IDLE || a.loadingItemId != null;
