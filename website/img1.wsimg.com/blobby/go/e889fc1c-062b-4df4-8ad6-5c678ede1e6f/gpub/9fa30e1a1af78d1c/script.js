...
Core.utils.deferBootstrap(
  {
    ...
    props: JSON.parse(
      '{"toggleId":"n-20439-navId-mobile","uniqueId":"n-20439","style":{"color":"highContrast",":hover":{"color":"highlight"},"@md":{"display":"none"}},"widgetId":"4b7f16d7-6066-4948-8f8c-2acbcf355f2f","section":"default","category":"primary","locale":"en-US","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
...
Core.utils.deferBootstrap(
  {
    ...
    props: JSON.parse(
      '{"toggleId":"more-20448","label":"More","dataAid":"NAV_MORE","navBarId":"navBarId-20445","parentId":"nav-20447","widgetId":"4b7f16d7-6066-4948-8f8c-2acbcf355f2f","section":"default","category":"primary","locale":"en-US","env":"production","renderMode":"PUBLISH"}'
    ),
    context: JSON.parse(
...
window.wsb["CalculateNavSpacing"](
  JSON.parse(
    '{"navId":"nav-20447","logoImageId":"logo-20444","containerId":"navBarId-20445"}'
  )
);
window.wsb["FullWidthScaler"] = function (e) {
  let {
      containerId: t,
      targetId: a,
      renderMode: o,
  ...
  function p() {
    const e = s ? n : document.getElementById(t),
      o = s ? i : document.getElementById(a),
      p = e.offsetWidth,
      u = e.getBoundingClientRect().width;
    if (p < l - 100 && o.innerText.length > 20)
      (o.style.fontSize = ""), (o.style.whiteSpace = "inherit");
    else {
      o.style.whiteSpace = "nowrap";
      const e = o.scrollWidth || 1,
        ...
        g = Math.min(r, Math.floor((a * l) / i));
      g !== a && (o.style.fontSize = `${g}px`);
    }
    n !== e && ((n = e), g.observe(n)), i !== o && ((i = o), g.observe(i));
  }
  return (
    p(),
    g.observe(n),
...
window.wsb["FullWidthScaler"](
  JSON.parse(
    '{"containerId":"tagline-container-20467","targetId":"dynamic-tagline-20468","maxSize":640,"tabletBreakpoint":768}'
  )
);
window.wsb["FadeIn"] = function (e) {
  let { targetId: t } = e;
  const a = () => {
...
window.wsb["FadeIn"](JSON.parse('{"targetId":"hero-20466"}'));
