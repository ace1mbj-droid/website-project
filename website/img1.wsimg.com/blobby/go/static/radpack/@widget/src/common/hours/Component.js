...
import {
  getWeekDayAbbr,
  toLocaleTimeString,
} from "../utils/helper-non-bootstrap";
...
class Hours extends Component {
  ...
  getHourLabel(hour) {
    ...
    if (hour.closed) {
      ...
      label = `${toLocaleTimeString(
        hour.openTime,
        locale
      )} – ${toLocaleTimeString(hour.closeTime, locale)}`;
    }
  ...
  render() {
    ...
    const structuredIndex =
      today === 0 ? structuredHours.length - 1 : today - 1;
        ...
        <table style={tableStyle}>
          ...
          >
            <td style={{ paddingRight: "medium" }}>
              <UX2.Element.Text
                data-aid={DataAid.CONTACT_HOURS_COLLAPSED_LABEL}
              >
                {collapsedLabel}
              </UX2.Element.Text>
            </td>
            <td>
              ...
              >
                <UX2.Element.Link
                  data-aid={DataAid.CONTACT_HOURS_COLLAPSED_HR_LABEL}
                  tag="span"
                >
            ...
            <td>
              <UX2.Element.Text
                data-aid={DataAid.CONTACT_HOURS_COLLAPSED_ARROW}
              >
                <UX2.Element.Link
                  group="Group"
                  tag="span"
        ...
        {structuredHours.map(({ hour }, index) => {
          ...
          return (
            ...
            >
              <td style={{ paddingRight: "medium" }}>
                <UX2.Element.Text
                  style={{ fontWeight: dayStyle, wordBreak: "normal" }}
                >
