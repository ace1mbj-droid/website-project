define("@widget/HTML/bs-Component-ae12ae5a.js", ["exports"], function (e) {
  "use strict";
  var t = {
    postMessageScript:
  ...
  class i extends (global.React || guac.react).Component {
    ...
    constructor(e) {
      super(...arguments),
        (this.iframe = (global.React || guac.react).createRef()),
        (this.isEdge =
          "undefined" != typeof window &&
          /Edge/.test(window.navigator.userAgent)),
        (this.iframeId = (global._ || guac.lodash).uniqueId(
          `iframe-${e.order}`
        ));
    }
    componentDidMount() {
    ...
    autoAdjustHeight(e) {
      ...
      t &&
        ...
        t.contentWindow.postMessage(t.getAttribute("id"), "*"),
        this.isIE ||
    ...
    render() {
      const { centerContent: e, iframeHeight: i, htmlSrc: o } = this.props,
        s = o.replace(/\$script/g, "/script"),
        n = e
          ? `${t.postMessageScript}<body style='margin: 0;'>${t.centerOpenTag}${s}</div></body>`
          : `${t.postMessageScript}<body style='margin: 0'>${s}</body>`,
        a = {
          width: "100%",
          display: "block",
          height: i ? `${i}px` : "auto",
      ...
      return (global.React || guac.react).createElement("iframe", {
        ...
        ref: this.iframe,
        sandbox:
          "allow-scripts allow-same-origin allow-forms allow-popups allow-presentation allow-top-navigation",
        src: r,
        srcDoc: n,
        style: a,
      });
