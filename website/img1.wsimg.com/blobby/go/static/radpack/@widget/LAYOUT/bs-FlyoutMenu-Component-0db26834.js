define(
  "@widget/LAYOUT/bs-FlyoutMenu-Component-0db26834.js",
  [
    "exports",
  ...
  function (e, o, t, p) {
    ...
    var a = {
      ...
      renderCustomContent: (global.PropTypes || guac["prop-types"]).oneOfType([
        (global.PropTypes || guac["prop-types"]).bool,
        (global.PropTypes || guac["prop-types"]).element,
        (global.PropTypes || guac["prop-types"]).node,
      ]),
    ...
    class s extends (global.React || guac.react).Component {
      ...
      componentDidUpdate(e, o) {
        let { open: t } = o;
        const { enableNoOverlapDropdown: p, customToggleStyles: a } =
          this.props;
        if (t !== this.state.open) {
          const { toggleId: o } = e,
            t = document.getElementById(o);
          t &&
            (p && (t.style.top = `${this.handleDropdownOffsetChange()}px`),
            a
              ? (global._ || guac.lodash).merge(
                  t.style,
                  a[this.state.open ? "open" : "close"]
                )
              : (t.style.display = this.state.open ? "block" : "none"));
        }
      }
      handleDropdownOffsetChange() {
        const { navBarId: e, parentId: o } = this.props,
          t = document.getElementById(e).getBoundingClientRect(),
          a = document.getElementById(o).getBoundingClientRect(),
          s = p.g();
        return t && a ? (t.height - (a.top - t.top)) / s : 0;
      }
      render() {
        const {
            label: e,
          ...
          { open: i } = this.state,
          d = (global._ || guac.lodash).omit(
            this.props,
            Object.keys(s.propTypes).concat(["Component", "renderMode"])
          ),
          u = i ? "180" : "0",
          y = {
            position: "relative",
        ...
        return (global.React || guac.react).createElement(
          t.T,
          o.a(
            { "data-aid": l, onChange: this.handleChange, isActive: r },
            d,
            i && this.props.activeProps,
            { "data-edit-interactive": !0, "aria-haspopup": "menu" }
          ),
          c ||
            (global.React || guac.react).createElement(
              "div",
              ...
              (global.React || guac.react).createElement(
                ...
                {
                  id: a,
                  icon: p.name || "chevronDown",
                  size: p.size || "small",
                  minTarget: p.minTarget || !1,
                  rotate: p.name ? "" : u,
                  style: y,
                }
              )
