define(
  "@widget/LAYOUT/c/bs-index3-84bb078b.js",
  [
    "radpack",
    "exports",
    ...
    "~/c/bs-index",
    "~/c/bs-dataAids",
    "@wsb/guac-widget-shared@^1/lib/components/ColorSwatch",
    "@wsb/guac-widget-shared@^1/lib/components/Carousel",
    "~/c/bs-navigationDrawer",
    "~/c/bs-searchFormLocations",
    "@wsb/guac-widget-shared@^1/lib/components/DynamicFontScaler",
  ],
  function (e, t, a, r, o, l, n, i, c, s, g, p) {
    "use strict";
    class u extends (
    ...
    a._(d, "propTypes", {
      ...
      (u.Half = d);
    const h = (global.PropTypes || guac["prop-types"]).shape({
    ...
    class w extends x.createElement("Grid") {
    ...
    const { utils: T } = (global.Core || guac["@wsb/guac-widget-core"]).UX2;
    class v extends T.createElement("Grid", "Cell") {
      ...
      static applyPushPullStyles() {
        ...
        if ((r > 0 && (e.marginLeft = y = this.getPercent(r, d)), o !== r)) {
          ...
          t !== y &&
            ((y = t), (global._ || guac.lodash).set(e, "@sm.marginLeft", y));
        }
        if (l !== o) {
          const t = l > 0 ? this.getPercent(l, m) : "initial";
          t !== y &&
            ((y = t), (global._ || guac.lodash).set(e, "@md.marginLeft", y));
        }
        if (n !== l) {
          const t = n > 0 ? this.getPercent(n, b) : "initial";
          t !== y &&
            ((y = t), (global._ || guac.lodash).set(e, "@lg.marginLeft", y));
        }
        let C = "initial";
        if ((c > 0 && (e.marginRight = C = this.getPercent(c, d)), s !== c)) {
          const t = s > 0 ? this.getPercent(s, h) : "initial";
          t !== C &&
            ((C = t), (global._ || guac.lodash).set(e, "@sm.marginRight", C));
        }
        if (g !== s) {
          const t = g > 0 ? this.getPercent(g, m) : "initial";
          t !== C &&
            ((C = t), (global._ || guac.lodash).set(e, "@md.marginRight", C));
        }
        if (p !== g) {
          const t = p > 0 ? this.getPercent(p, b) : "initial";
          t !== C &&
            ((C = t), (global._ || guac.lodash).set(e, "@lg.marginRight", C));
        }
        return e;
      }
    ...
    (E.Banner = R), (E.Split = M);
    const S = "cardBackground",
      H = (global.PropTypes || guac["prop-types"]).shape({
        url: (global.PropTypes || guac["prop-types"]).string,
        pageId: (global.PropTypes || guac["prop-types"]).string,
        widgetId: (global.PropTypes || guac["prop-types"]).string,
        linkId: (global.PropTypes || guac["prop-types"]).string,
    ...
    a._(D, "propTypes", {
      ...
      a._(D, "defaultProps", { closeOnClickOutside: !1, preventShrink: !1 });
    class U extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ...
    a._(U, "propTypes", {
      ...
      a._(U, "defaultProps", { closeOnClickOutside: !1, preventShrink: !1 });
    class W extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ...
    a._(W, "propTypes", {
      ...
      a._(W, "defaultProps", { preventShrink: !1 });
    class O extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ...
    a._(q, "propTypes", {
      ...
      a._(q, "defaultProps", { isPriceShown: !0 });
    class Y extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ...
    class te extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ).UX2.utils.createElement("CommerceCard", "Colors") {}
    a._(te, "propTypes", {
    ...
    class ae extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ).UX2.utils.createElement("CommerceCard", "Carousel") {}
    a._(ae, "propTypes", {
      width: (global.PropTypes || guac["prop-types"]).number,
      hasImageBorder: (global.PropTypes || guac["prop-types"]).bool,
      imageShape: (global.PropTypes || guac["prop-types"]).string,
    ...
    const {
      renderModes: { PUBLISH: oe },
    } = (global.Core || guac["@wsb/guac-widget-core"]).constants;
    class le extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ).UX2.utils.createElement("Drawer") {
      componentDidUpdate() {
        const { renderMode: e } = this.props;
        e === oe && this.handleBodyOverflow();
      }
      handleBodyOverflow() {
        const { isOpen: e } = this.props;
        e
    ...
    class ne extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ).UX2.utils.createElement("PlaceholderMessage") {}
    a._(ne, "propTypes", {
      section: (global.PropTypes || guac["prop-types"]).string,
    ...
    class ie extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ).UX2.utils.createElement("Ribbon") {}
    a._(ie, "propTypes", {
      children: (global.PropTypes || guac["prop-types"]).string,
      dataAids: (global.PropTypes || guac["prop-types"]).objectOf(
        (global.PropTypes || guac["prop-types"]).string
    ...
    const { utils: ce } = (global.Core || guac["@wsb/guac-widget-core"]).UX2;
    class se extends ce.createElement("SplitPane") {}
    a._(se, "propTypes", {
      children: (global.PropTypes || guac["prop-types"]).node,
      split: (global.PropTypes || guac["prop-types"]).oneOf([
        "even",
        "start-large",
        "end-large",
      ]),
      fullBleed: (global.PropTypes || guac["prop-types"]).bool,
      flip: (global.PropTypes || guac["prop-types"]).bool,
      gutter: (global.PropTypes || guac["prop-types"]).bool,
      spacingXs: (global.PropTypes || guac["prop-types"]).oneOfType([
        (global.PropTypes || guac["prop-types"]).string,
        (global.PropTypes || guac["prop-types"]).number,
      ]),
      spacingSm: (global.PropTypes || guac["prop-types"]).oneOfType([
        (global.PropTypes || guac["prop-types"]).string,
        (global.PropTypes || guac["prop-types"]).number,
      ]),
      spacingMd: (global.PropTypes || guac["prop-types"]).oneOfType([
        (global.PropTypes || guac["prop-types"]).string,
        (global.PropTypes || guac["prop-types"]).number,
      ]),
      spacingLg: (global.PropTypes || guac["prop-types"]).oneOfType([
        (global.PropTypes || guac["prop-types"]).string,
        (global.PropTypes || guac["prop-types"]).number,
      ]),
      roundedCorners: (global.PropTypes || guac["prop-types"]).bool,
      style: (global.PropTypes || guac["prop-types"]).object,
    }),
      a._(se, "defaultProps", {
        split: "even",
    ...
    const { utils: ge } = (global.Core || guac["@wsb/guac-widget-core"]).UX2;
    class pe extends ge.createElement("SplitPane", "Media") {}
    a._(pe, "propTypes", {
      mediaData: (global.PropTypes || guac["prop-types"]).object,
    });
    const { utils: ue } = (global.Core || guac["@wsb/guac-widget-core"]).UX2;
    class de extends ue.createElement("SplitPane", "Content") {}
    a._(de, "propTypes", {
      children: (global.PropTypes || guac["prop-types"]).node,
      renderAsCard: (global.PropTypes || guac["prop-types"]).bool,
    }),
      a._(de, "defaultProps", { renderAsCard: !0 }),
      (se.Media = pe),
      (se.Content = de);
    var he = {
      __proto__: null,
      ...
      CommerceCardColors: te,
      CommerceCardCarousel: ae,
      Video: re,
      Drawer: le,
      PlaceholderMessage: ne,
      Ribbon: ie,
      SplitPane: se,
    };
    function me() {
      ...
      (global.Core || guac["@wsb/guac-widget-core"]).utils.register({
        Group: {
          ...
          SlideshowArrows: [],
          SocialLinks: ["Drawer", "NavBar"],
          SplitItem: ["Image"],
          UtilitiesMenu: [],
          HeaderMedia: [r.F, r.b, r.c, r.B, r.L],
          Sidebar: [],
          SubMenu: [],
          Ribbon: [],
        },
        Element: {
          ...
          HR: [],
          Icon: ["Hamburger", "Search", "Social", "Airo", "TrustedSite"],
    ...
    const ve = {
      ...
      Ve = [ke, Le, Ee, "mlarge", Re, Me, Se, He, ze, Ae, Be, Ie];
    function Xe(e, t) {
      const a = t && Te.indexOf(t) >= 0;
      if (Ve.indexOf(e) < 0) return e;
      const r = this.mappedValues.fontSizeMapping || ve,
        o = r.xs.medium,
    ...
    function De(e, t) {
      const a = (this.mappedValues.fontSizeMapping || ve)[t];
      return a ? (global._ || guac.lodash).clamp(e, a.xsmall, a.xxjumbo) : e;
    }
    var Ue = {
      fontSize: function () {
        let e =
        ...
        const t = (function (e) {
            ...
            const t = Te.find((t) => 0 === e.indexOf(t));
            if (!t) return;
            const a = (global._ || guac.lodash).lowerFirst(e.substr(t.length));
            return -1 !== Ve.indexOf(a)
              ? { deviceSize: t, newFontSize: a }
              : void 0;
          })(e),
        ...
        if ((l && (o *= Number(l) || 1), !t)) {
          if (Ve.indexOf(e) >= 0) {
            const t = Xe.call(this, e, ye);
            return De.call(this, Math.round(t * o), ye);
          }
          return e;
        }
        const n = Xe.call(this, t.newFontSize, t.deviceSize);
        return De.call(this, Math.round(n * o), t.deviceSize);
      },
    };
    const We = "lighter",
      Oe = "light",
        ...
        return -1 === je.indexOf(e)
          ...
          : (function (e) {
              ...
              if (!(r in Ze)) {
                ...
                Ze[r] = {
                  [We]: o[0],
                  [Oe]: (l > 1 && o[Math.round(l / 3)]) || e,
                  [_e]: e,
                  [Ne]: (i > 1 && n[Math.round(i / 3)]) || e,
                  [Fe]: n[i - 1],
                };
              }
              return Ze[r];
    ...
    const { CTAButton: Ge } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      qe = { left: "flex-start", right: "flex-end", center: "center" };
    class Ye extends (global.React || guac.react).Component {
      render() {
        const { action: e, alignment: t } = this.props,
          { children: a, link: r, ...o } = e,
          l = t ? { alignSelf: qe[t] } : {},
          n = {
            element: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
              .Button.Secondary,
            ctaButton: { label: a, enabled: !0, ...r },
            ...o,
          };
        return (global.React || guac.react).createElement(
          ...
          {
            style: l,
            children: (global.React || guac.react).createElement(Ge, n),
          }
        );
      }
    }
    ...
    const { Link: Je } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      Qe = (global.PropTypes || guac["prop-types"]).shape({
        url: (global.PropTypes || guac["prop-types"]).string,
        pageId: (global.PropTypes || guac["prop-types"]).string,
        widgetId: (global.PropTypes || guac["prop-types"]).string,
        linkId: (global.PropTypes || guac["prop-types"]).string,
    ...
    class Ke extends (global.React || guac.react).Component {
      render() {
    ...
    const {
      ...
      tt = 340,
      at = 60;
    class rt extends (global.React || guac.react).Component {
      getPlainCaption(e) {
        let t;
        const a = e.blocks;
        if (a.length > 1) {
      ...
      renderCollapsedText(e) {
        const { alignment: t } = this.props,
          ...
          {
            collapseThreshold: l = tt,
            collapseMinOverflow: n = at,
            expandIconProps: i = {},
            collapseIconProps: c = {},
            renderMode: s,
          } = o;
        ...
        const p = (g ? this.getPlainCaption(g).length : r.length) > l + n,
          ...
          b = {
            ...
            style: {
              display: "none",
              [`:checked ~ #${h}`]: { display: "block" },
              [`:checked ~ #${d}`]: { display: "none" },
              [`:not(:checked) ~ #${h}`]: { display: "none" },
              [`:not(:checked) ~ #${d}`]: { display: "block" },
            },
          },
          y = (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
            { id: d, style: { display: u ? "none" : "block" } },
            (global.React || guac.react).createElement(
            ...
            (global.React || guac.react).createElement(
              ...
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                  .MoreLink.Expand,
                a.a({ style: { marginVertical: "xsmall" } }, i)
              )
            )
          ),
          C = (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
            { id: h, style: { display: u ? "block" : "none" } },
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Text,
              a.a(
                { alignment: t },
            ...
            (global.React || guac.react).createElement(
              ...
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                  .MoreLink.Expand,
                a.a({ style: { marginVertical: "xsmall" }, expanded: !0 }, c)
              )
            )
          );
        return p
    ...
    const ot = { left: "flex-start", right: "flex-end" };
    function lt(e) {
      let {
        alignment: t = "center",
        heading: a,
      ...
      return (
        n &&
          (l = (global.React || guac.react).createElement(Ye, {
            key: "action",
            action: n,
          })),
        this.merge(
          {
            ...
            children: [
              !!c &&
                c.children &&
                (global.React || guac.react).createElement(Ke, {
                  key: "heading",
                  heading: c,
                }),
              !!s &&
                s.children &&
                (global.React || guac.react).createElement(rt, {
                  key: "text",
                  text: s,
                  alignment: t,
                }),
          ...
          children: t.map((e, t) =>
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component.Grid
                .Cell,
              a.a({}, o || s, { key: e.key || t, children: r(e, t), style: l })
            )
          ),
          style: {
            textAlign: "center",
    ...
    function it(e) {
      let { heading: t, subheading: r, ...l } = e;
      const n = t && o.s(t),
        i = r && o.s(r);
      return this.merge(
        {
    ...
    function ct(e) {
      ...
      const l = this.base.keyId,
        ...
        i = [];
      for (; r--; )
        o >= 1 ? i.push(100) : o < 1 && o > 0 ? i.push(100 * o) : i.push(0),
          o--;
      return this.merge(
        {
          tag: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          ...
          style: { display: "flex", backgroundColor: "section" },
        },
        a
      );
    }
    function st(e) {
      let { heading: t, headingProps: r = {}, action: o, ...l } = e;
      return this.merge(
        {
          tag: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
            .Container,
    ...
    function gt(e) {
      ...
      x && (v[":after"] = { content: '""', flex: "auto", maxWidth: "25%" }),
        C && (v.flexDirection += "-reverse"),
        w.applySizingStyles(v, e, this);
      const P = {
          gutter: b,
          bottom: m,
          equal: h,
        ...
        k = f ? { ...P, inset: f } : P,
        L = (global.React || guac.react).Children.toArray(u)
          .filter((e) => {
            const t = typeof e;
            return "object" === t
          ...
          .map((e, t) => {
            ...
            let r;
            if (a && a.prototype) {
              if (a === T || a.prototype instanceof T)
                return (global.React || guac.react).cloneElement(e, k);
              (a === w || a.prototype instanceof w) &&
      ...
      return L.length
        ? this.merge(
            { tag: p, style: v, children: L },
            (global._ || guac.lodash).omit(e, Object.keys(w.propTypes))
          )
        : null;
    }
    function pt(e) {
    ...
    function ut(e) {
      let { heading: t, subheading: a, media: r, ...l } = e;
      return this.merge(
        {
          tag: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          children: [
            r &&
              ...
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                  .Background,
                { key: "background", backgroundImage: r.url }
              ),
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                .HeadingPair,
              { key: "heading", heading: t, subheading: a }
            ),
          ],
          style: {
            textAlign: "left",
          ...
          children: (global.React || guac.react).createElement(
            ...
            t &&
              (global.React || guac.react).createElement("source", {
                srcSet: t,
                media: `(max-width: ${dt}px)`,
              }),
            a &&
              (global.React || guac.react).createElement("source", {
                srcSet: a,
                media: `(min-width: ${ht}px) and (max-width: ${mt}px)`,
              }),
            r &&
              (global.React || guac.react).createElement("source", {
                srcSet: r,
                media: `(min-width: ${bt}px) and (max-width: ${yt}px)`,
              }),
            o &&
              (global.React || guac.react).createElement("source", {
                srcSet: o,
                media: `(min-width: ${Ct}px) and (max-width: ${ft}px)`,
              }),
            l &&
              (global.React || guac.react).createElement("source", {
                srcSet: l,
    ...
    const {
        imageDimensionConfig: Tt,
        FIT_IMAGE: vt,
        LANDSCAPE: Pt,
        CIRCLE: kt,
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .imageDimensions,
      Lt = "//img1.wsimg.com/isteam/ip/static/transparent_placeholder.png",
      Et = Tt[Pt].aspectRatio,
      Rt = kt,
      Mt = /[.-]wsimg\.com\//;
    function St(e) {
      return !!Mt.test(e);
    ...
    function At(e, t) {
      const a = (function (e) {
        if (!St(e)) return null;
        const [t, a] = e.split("/:/");
        return { source: t, operations: Ht(a) };
      })(e);
      return null == a
        ? e
        : (function (e) {
            let { source: t, operations: a } = e;
            if (null == a) return t;
            const r = a
              .map((e) => {
                let { name: t, value: a } = e;
                return null == a ? t : `${t}=${a}`;
              })
              .join("/");
            return r ? t + "/:/" + r : t;
          })({ source: a.source, operations: [...a.operations, ...zt(t)] });
    }
    function Bt(e) {
      let t =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
    ...
    function It(e, t, a) {
      return "string" == typeof (e?.imageUrl || e?.image)
        ? (function (e) {
            return St(e)
              ? e
              : (function () {
        ...
        : a?.fallbackBackgroundImageSrc
        ? a.fallbackBackgroundImageSrc.replace(/\{(width|height)\}/g, "+0")
        : t || "";
    }
    function Vt(e, t) {
      return t.map(
        (t) =>
          `${(function (e, t) {
            const { outputHeight: a, outputWidth: r, aspectRatio: o } = e;
            let l = Math.max(0, Math.min(r, t));
            const n = r / l;
            let i,
              c = Math.floor(a / n);
            return (
    ...
    const {
      ...
      jt = [
        { max: 450, isMobile: !0, breakpoint: "@xs-only" },
        { min: 451, max: Xt, isMobile: !0, breakpoint: "@xs-only" },
        { min: Dt, max: Ut, isTablet: !0, breakpoint: "@sm-only" },
        { min: Wt, max: Ot, breakpoint: "@md-only" },
        { min: _t, max: Nt, breakpoint: "@lg-only" },
        { min: Ft, max: 1920, breakpoint: "@xl" },
        { min: 1921, breakpoint: "@xl" },
      ],
      Zt = [1, 2, 3],
      { HEADER: $t } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .widgetTypes,
      { PUBLISH: Gt } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .renderModes;
    function qt(e) {
      return e.replace(/"/g, '\\"');
    }
        ...
        (t, c) => (
          (l ? [1] : Zt).forEach((l) => {
            const s = c.isMobile ? o : r,
              g = [
                a && a((!c.isMobile && !c.isTablet) || !n),
                `url("${qt(
                  At(e, { rs: c.max ? `w:${s * c.max * l},m` : "w:100%25" })
                )}")`,
              ]
                .filter(Boolean)
                .join(", ");
              ...
              i
                ? (function (e) {
                    ...
                    const o = [
                      ...
                      .join(" and ");
                    return 1 !== r
                      ? `@media ${o} and (-webkit-min-device-pixel-ratio: ${r}), ${o} and (min-resolution: ${
                          96 * r
                        }dpi)`
                      : `@media ${o}`;
                  })({ ...c, density: l })
    ...
    function Jt(e) {
      ...
      const {
        ...
        { parallaxEnabled: L, position: E, alt: R } = c,
        M = P === Gt,
        S = (global._ || guac.lodash).omit(f, [
          "title",
          "treatment",
          "overlayAlpha",
          "overlay",
        ...
        H = this.constructor.getMutatorDefaultProps(
          x,
          w
        ).showOverlayOpacityControls,
        z = this.constructor.getDefaultBackgroundFilter(x, w);
      let A = { ...(x !== $t && { textShadow: l.a }), ...t };
      const B = {
        backgroundPosition: L ? "center" : E || o || "center",
      ...
      const D =
          a ||
          c.backgroundImage ||
          It({ filter: z, additionalUrlParams: [m && "fx-bl=s:90"], ...c }),
        U = f.overlay || this.constructor.getDefaultImageOverlayType(x, w);
      if (U !== r.a) {
        const e = () => {
            if (U === r.f) {
              if ("primary" !== v) return "sectionOverlay";
              return (global.Core || guac["@wsb/guac-widget-core"]).UX2.utils
                .getTheme(T, { category: "primary", section: "default" })
          ...
          t = (global.Core || guac["@wsb/guac-widget-core"]).UX2.utils
            .getTheme(T, { category: v, section: "overlay" })
            .mapPropValue("backgroundColor", e()),
          a = this.constructor.getDefaultImageOverlayOpacity(x, w),
          o = c?.overlayAlpha;
        let l = o ?? a;
        "HEADER" !== x || C === r.d || H || (l = 0),
          (V = !0),
          (X = (e) => (
            (t.alpha = e ? l : 0),
            `linear-gradient(to bottom, ${t} 0%, ${t} 100%)`
          ));
      }
      const W =
          a || c.backgroundImage || !St(D)
            ? {
                backgroundImage: [V && X(!0), `url("${qt(D)}")`]
                  .filter(Boolean)
                  .join(", "),
              }
            : Yt(
      ...
      if (
        (O &&
          ((B.backgroundImage = `${D}, url("${O.replace(/"/g, '\\"')}")`),
          p && (B.backgroundSize = `${B.backgroundSize}, ${p}`)),
        V && (B.backgroundSize = `auto, ${B.backgroundSize}`),
        !D.length && !O.length)
      )
        return this.merge({ style: A, children: u }, S);
      ...
      return (
        N
          ? (I = (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
              { "data-lazybg": !0, className: "d-none", style: { ...B, ...W } }
            ))
          : (A = { ...A, ...B, ...W }),
        this.merge(
          {
    ...
    function Qt(e) {
      return this.Background({ ...e, desktopWidthMultiplier: 0.5 });
    }
    const Kt = {
    ...
    function ea(e) {
      let { fixedWidth: t, children: a, innerContainerStyle: r, ...o } = e;
      const l = {
    ...
    const {
        renderModes: ta,
        widgetTypes: { HEADER: aa, FOOTER: ra },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      oa = [
        "theme",
        "category",
    ...
    function la(e) {
      let { children: t, ...a } = e;
      const { widgetType: r } = this.base;
      let o;
      if (this.base.renderMode === ta.PUBLISH && r === ra) {
        ...
        o = (global.React || guac.react).createElement(
          ...
          null,
          `.page-inner { background-color: ${e}; min-height: 100vh; }`
        );
      }
      const l = r === aa ? "main" : r === ra ? "contentinfo" : "region",
        n =
          "HEADER" === this.base.widgetType && !a.tagline && a.isHomepage
            ? (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                  .Element,
                { style: { display: "none" }, "data-route": "tagline" }
              )
            : null,
        i =
          this.base.renderMode === ta.EDIT
            ? (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                  .Element,
      ...
      return this.merge(
        ...
        (global._ || guac.lodash).pickBy(
          a,
          (e, t) => -1 !== oa.indexOf(t) || 0 === t.indexOf("data-")
        )
      );
    }
    function na(e) {
      return this.Widget(this.merge({ groupType: "Banner" }, e));
    }
    function ia(e) {
      return this.Widget(this.merge({ groupType: "Split" }, e));
    }
    const { Link: ca } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      sa = (global.PropTypes || guac["prop-types"]).shape({
        url: (global.PropTypes || guac["prop-types"]).string,
        pageId: (global.PropTypes || guac["prop-types"]).string,
        widgetId: (global.PropTypes || guac["prop-types"]).string,
        linkId: (global.PropTypes || guac["prop-types"]).string,
    ...
    class ga extends (global.React || guac.react).Component {
      render() {
        const { widgetPreset: e } = this.props;
        ...
        let p = {
          imageData: { image: t },
          style: { height: i, width: c, ...n },
        };
        const u = { style: { marginLeft: "auto", marginRight: "auto", ...l } },
          d = "image" === o;
        d || (u.style.width = "100%"),
          s
            ? (p = { ...p, ...g })
        ...
        const h =
          ...
          m = d
            ? (global.React || guac.react).createElement(
                h,
                a.a({ isContentCard: !0 }, p)
              )
            : (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                  .Background,
                { imageData: t, style: p.style }
              ),
          b = r
            ? (global.React || guac.react).createElement(ca, { linkData: r }, m)
            : m;
        return (global.React || guac.react).createElement(
    ...
    const { getSelectedVideoProps: pa } = (
      global.Core || guac["@wsb/guac-widget-core"]
    ).utils;
    function ua(e) {
      let {
      ...
      const { widgetPreset: m } = this.base,
        b = {
          width: "inherit",
          top: 0,
          ...(d && { "@md": { position: "absolute" } }),
          ...(u && { "@sm-only": { position: "absolute" } }),
        },
        y =
          t &&
          (global.React || guac.react).createElement(Ke, {
        ...
        C =
          i &&
          (global.React || guac.react).createElement(ga, {
            key: "image",
            image: i,
            widgetPreset: m,
          }),
      ...
      n &&
        (global._ || guac.lodash).isPlainObject(l) &&
        (l.style = { flexGrow: 0 });
      const x =
          l &&
          l.children &&
        ...
        w = "about1" === m ? { alignment: s } : {},
        T =
          n &&
          (global.React || guac.react).createElement(
            Ye,
            a.a({ key: "action", action: n }, w)
          ),
        v = [
          [
            t,
                    ...
                    .Block,
                  {
                    ...
                    style: {
                      ...
                      ...(g.has("sm")
                        ...
                        : {}),
                      ...(g.has("md") ? { "@md": { display: "block" } } : {}),
                    },
                  },
                  [y, Array.from(g.values())]
                )
              : y,
          ],
          [i, C],
        ...
        P = (global._ || guac.lodash)
          .sortBy(v, (e) => {
            const t = (global._ || guac.lodash).get(e[0], "style.order", 0);
            return (global._ || guac.lodash).isNil(t) ? 0 : t;
          })
          .map((e) => e[1]);
      let k = (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
        L = {
          position: "relative",
          display: "flex",
          flexDirection: "column",
          alignItems: { left: "flex-start", right: "flex-end" }[s] || s,
          textAlign: s,
          justifyContent: "flex-start",
          width: "100%",
          "> *": { maxWidth: "100%" },
          ...o.a("medium"),
          "@xs-only": o.a("about3" === m ? "small" : "medium"),
        },
        E = {};
      const {
        src: R,
      ...
      if (M === S) {
        (k = (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
          .Background),
          (E = {
            overlay: H || r.A,
          ...
          (R || (B && B.image)) &&
            ((E.category = "accent"), (E.section = "overlay")),
          (L = (global._ || guac.lodash).merge(
            L,
            {
              width: "100%",
              height: "100%",
              ...
              "@md-only": { paddingHorizontal: "large" },
            },
            A
          ));
        const e = P.findIndex((e) => "image" === e.key);
        !(global._ || guac.lodash).isNil(e) && P.splice(e, 1);
      }
      return this.merge(
        { tag: k, group: "Content", groupType: "Card", children: P, style: L },
        E,
        h
      );
    }
    ...
    function ha(e) {
      ...
      const c = 1 === t.length,
        ...
        p = (function () {
          ...
          const a = (e, t) => {
            ...
            return a.map((e) => {
              const t = e.map(
                (e) =>
                  Number(e?.image?.imageData?.outputWidth ?? 0) /
                  Number(e?.image?.imageData?.editedAspectRatio || 1)
              );
              return 1 === new Set(t).size;
            });
          };
          return { sm: a(e, 2), md: a(e, t) };
        })(t, s),
        u = { "@md": c ? 1 : s, "@sm": c ? 1 : 2 },
        d = t.map((e, r) => {
          const { style: o = {}, id: l, ...n } = e,
            i = {
              visibility: "hidden",
              position: "absolute",
              marginBottom: "medium",
              ...
              d &&
                ...
                b.set(
                  ...
                  (global.React || guac.react).createElement(Ke, {
                    ...
                    style: { ...i, "@sm-only": { position: "relative" } },
                    heading: d,
                  })
                )),
            (global.React || guac.react).createElement(
        ...
        h = {
          data: d,
          cellStyle: { display: "flex", ...r },
          style: { "@xs-only": o.a("medium") },
        };
      return (
        l &&
          ((h.cellProps = {
          ...
          (h.style = {
            ...h.styles,
            justifyContent: d.length <= l + 1 ? "center" : "flex-start",
          })),
        this.ContentWrap(this.merge(h, i))
      );
    }
    function ma(e) {
      let {
      ...
      const s = this.parseSizedUnit(this.mapPropValue("spacing", "medium"))[0],
        g = o ? "Left" : "Right",
        p = n ? { marginHorizontal: `-${s}px` } : {},
        u = l ? { "@md": { height: "100%", [`margin${g}`]: `-${s}px` } } : {},
        d = [
          t
            ? (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
          ...
          r
            ? (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                  .Grid.Cell,
                { key: "slot2", style: { flex: 1, "@md": { flex: 1 } } },
                (global.React || guac.react).createElement(
                  (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                    .Block,
                  { style: { ...p, ...u, position: "relative" } },
                  r
                )
              )
            : null,
    ...
    function ba(e) {
      ...
      return this.HorizontalBox(
        this.merge(
          {
            alignX: t || "middle",
            style: { flexDirection: "column", width: "auto", height: "100%" },
          },
          a
        )
      );
    ...
    function ya(e) {
      ...
      return this.Box(
        this.merge(
          { alignX: t || "left", style: { height: "auto", width: "100%" } },
          a
        )
      );
    }
    function Ca(e) {
      let { alignX: t, alignY: a, ...r } = e;
      const o = {
        top: "flex-start",
        left: "flex-start",
        start: "flex-start",
      ...
      const c = (global._ || guac.lodash).merge(
        ...
        s = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component.Modal
            .Body,
          { children: t, onClose: a, preventShrink: o, width: l }
        );
      return this.merge(
        {
          tag: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
    ...
    const xa = (e) => {
      let { id: t, onClose: a, style: r } = e;
      const o = (global._ || guac.lodash).merge(
        {
          icon: { color: "highContrast", cursor: "pointer" },
          container: {
            display: "flex",
    ...
    function Ta(e) {
      ...
      const c = {
          "@sm": {
            ...
            alignItems: "center",
            pointerEvents: "none",
            ":before": { display: "block", height: "90vh", content: '""' },
          },
        },
        s = {
          position: "relative",
        ...
        p = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          {
            style: g.body,
            onClick: (e) => {
          ...
          (global.React || guac.react).createElement(xa, {
            id: t,
            onClose: a,
            style: n.closeIcon,
          }),
          (global.React || guac.react).createElement(wa, {
            children: r,
            style: n.content,
          })
        );
    ...
    const { NEUTRAL: va } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants.categoryTypes,
      { EDIT: Pa } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .renderModes,
      { SIDELINE_SIDEBAR_ZINDEX: ka } = (
        global.Core || guac["@wsb/guac-widget-core"]
    ...
    function La(e) {
      ...
      const { renderMode: c } = this.base,
        s = {
          modal: {
            position: c === Pa ? "absolute" : "fixed",
            display: "flex",
          ...
          content: {
            ...
            "> *:not(:last-child)": { marginBottom: "large" },
            "@sm": { paddingHorizontal: "large" },
          },
        },
        g = (global._ || guac.lodash).merge(s, n),
        p = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component.Modal
            .Body,
          {
    ...
    const { POPUP: Ea } = (global.Core || guac["@wsb/guac-widget-core"])
      .constants.widgetTypes;
    function Ra(e) {
      let { style: t = {}, ...a } = e;
      const { widgetType: r } = this.base,
        o = {
          ...(r === Ea && { position: "absolute" }),
          padding: "0",
          top: "0",
          left: "0",
          bottom: "0",
    ...
    function Ma(e) {
      ...
      const { renderMode: p } = g,
        u = Number(s) && o ? o.bind(null, s) : () => !1,
        d = { product: r, getStyles: u, translate: i };
      return this.merge(
        {
          tag: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          group: "Product",
          ...
          children: [
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group.Product
                .Asset,
              a.a({ key: "asset" }, t, { dataAids: l, imageCropMethod: n })
            ),
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group.Product
                .Name,
              { key: "name", product: r, getStyles: u }
            ),
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group.Product
                .Prices,
              a.a({ key: "price" }, d, { renderMode: p, dataAids: l })
            ),
            r.variant_count && r.variant_count >= 2
              ? (global.React || guac.react).createElement(
    ...
    function Sa(e) {
      let { alignment: t = "left", heading: r = {}, text: o = {}, ...l } = e;
      const n = r && r.children,
        i = o && o.children;
      if (!n && !i) return null;
      const c = {
          paddingTop: n ? "xsmall" : 0,
          "@md": { paddingTop: n ? "small" : 0 },
        },
        s = { marginBottom: 0, "@md": { marginBottom: 0 } },
        g = i
          ? (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component.Grid,
              { key: "intro", inset: "center" === t, bottom: !1 },
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Text,
                a.a({ style: c }, o)
              )
        ...
        p = n
          ? (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                .Heading,
              a.a({ key: "heading", style: s }, r)
            )
          : null;
      return this.merge(
        {
          tag: (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          style: { marginBottom: n ? "xlarge" : "medium", textAlign: t },
          children: [p, g],
        },
        l
      );
    ...
    function Ha(e) {
      ...
      const g = {
        ...
        container: {
          ...
          "@xs-only": { paddingHorizontal: "large" },
        },
        buttonGroupWrapper: {
          display: "flex",
          justifyContent: "center",
        ...
        buttonStyle: { ...r.style },
        ...(o && { secondaryButtonStyle: { ...o.style } }),
      };
      let p = null;
      if (
        n ===
        ...
        const e = (global._ || guac.lodash).get(
          window,
          "ux.Button",
      ...
      return this.merge({ children: p }, { style: { margin: "0 auto" } }, s);
    }
    const { DEFAULT: za, ALT: Aa } = (
      global.Core || guac["@wsb/guac-widget-core"]
    ).constants.sectionTypes;
    function Ba(e) {
      let { children: t, icon: a, onClose: r, section: o, ...l } = e;
      const n = {
          container: {
            display: "flex",
          ...
          icon: { flexShrink: 0, marginRight: "xsmall", color: "section" },
    ...
    function Ia(e) {
      ...
      const i = {
          ...
          errorWrapperDesktop: { "@xs-only": { display: "none" } },
          errorWrapperMobile: {
            "@sm": { display: "none" },
            marginBottom: "medium",
          },
          inputWrapper: {
            ...
            "@sm": { marginVertical: "xxsmall" },
          },
          input: {
            width: "100%",
            "@sm": { marginRight: "medium", height: "100%" },
            ...(t.style || {}),
          },
          button: {
            width: "100%",
            marginHorizontal: 0,
            "@xs-only": { marginVertical: 0 },
            "@sm": { marginVertical: "xxsmall", maxWidth: "30%" },
            ...(r.style || {}),
          },
          error: {
            position: "static",
        ...
        s = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Button
            .Primary,
          a.a({ tag: "button", type: "submit" }, r, { style: i.button })
        ),
        g =
          o &&
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Error,
            a.a({ alert: !0 }, l, { style: i.error }),
            o
          ),
        p = (global.React || guac.react).createElement(
          (global.React || guac.react).Fragment,
    ...
    const Va = "major",
      Xa = "medium",
      Da = {
        mobile: { display: "block", "@md": { display: "none" } },
        desktop: { display: "none", "@md": { display: "block" } },
      };
    function Ua(e) {
      let {
          name: t,
      ...
      const C = n ? { category: "accent" } : { category: b };
      let f = "accent";
      n || (f = "primary" === b ? "primary" : "neutral");
      const x = n ? "transparent" : y;
      let w = (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group
        .CommerceOverlay;
      o === Va
        ? (w = (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group
      ...
      const T = {
          ...
          price: u,
          salePrice: d,
          titleProps: { align: o === Va || o === Xa ? "center" : "left" },
          dataAids: h,
        },
        v = (global.React || guac.react).createElement(
          w,
          null,
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
              .CommerceCardPictureContainer,
            a.a({ backgroundColor: x }, C),
            (global.React || guac.react).createElement(
              (global.React || guac.react).Fragment,
              null,
              n &&
                (global.React || guac.react).createElement(
                  (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                    .CommerceCardPicture,
                  { backgroundAssetUrl: r, overlayAlpha: i }
                ),
              o !== Va &&
                (global.React || guac.react).createElement(
                  (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group
              ...
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                  .CommerceCardContent,
                a.a({}, T, { style: o === Va ? {} : Da.desktop })
              )
            )
          )
        );
      return this.merge({ children: v }, m);
    }
    function Wa(e) {
      let {
        imageList: t,
    ...
    function Oa(e) {
      let { dataAids: t = {}, hoverButtonText: a, onHoverButtonClick: r } = e;
      return (global.React || guac.react).createElement(
        (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
        {
    ...
    function _a(e) {
      let {
        ...
        renderColorsLabel: H,
        hoverButtonText: z,
        onHoverButtonClick: A,
        dataAids: B,
        dataRoutes: I,
        ratingsAlignLeft: V,
        carouselWidthOffset: X,
        strikeThroughPrice: D,
        renderInventoryWarning: U,
        ...W
      } = e;
      const O = m
          ? (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group.Card.Link
          : (global.React || guac.react).Fragment,
        _ = m && { style: { flexGrow: 1, maxWidth: "100%" } },
        N = { cursor: "pointer", ...b },
        F = m ? { display: "flex", height: "100%", ...N } : { ...N },
        j = Boolean(o || g || p || u),
        Z = {
          name: t,
          duration: a,
          ...
          ratingsAlignLeft: V,
          strikeThroughPrice: D,
          titleProps: { align: !j && m ? "center" : "left" },
          isPriceShown: T,
          renderInventoryWarning: U,
        },
        $ = l
          ? (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                .Ribbon,
              { dataAids: B, size: i, ribbonType: n },
              l
            )
          : null,
        G = z
      ...
      return this.merge({ children: Y, style: F }, W);
    }
    (Wa.propTypes = {
      imageList: (global.PropTypes || guac["prop-types"]).array,
      imageShape: (global.PropTypes || guac["prop-types"]).string,
    ...
    const Na = { vertical: "133%", square: "100%", horizontal: "75%" };
    function Fa(e) {
      let {
        children: t,
        backgroundColor: a,
      ...
      return this.Block(this.merge({ children: s, style: c }, i));
    }
    const ja = {
      eyebrow: { marginBottom: "xsmall", textTransform: "uppercase" },
      priceRowLeft: { display: "flex", flexDirection: "column" },
      priceRowRight: {
        display: "flex",
        alignItems: "center",
      ...
      eventDate: { marginTop: "xxsmall" },
      footer: { marginTop: "small" },
      button: { marginTop: "xsmall" },
    };
    function Za(e) {
      let {
        name: t,
      ...
      const X =
        ...
        U = this.merge(
          {
            position: "relative",
            paddingHorizontal: w ? "small" : "0",
            paddingBottom: w && H ? "medium" : "0",
            ...X,
          },
          S
        ),
        W =
          k && b
            ? (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block
            : (global.React || guac.react).Fragment,
        O = k && b && { style: A ? ja.priceRowLeft : ja.priceRowRight },
        _ = Boolean(y?.length),
        N = "large" === f?.xs,
        F = I ? I() : null,
        j = (global.React || guac.react).createElement(
          (global.React || guac.react).Fragment,
          null,
          F,
          s &&
            ...
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Details
                .Minor,
              { style: ja.eyebrow, "data-aid": T.eyebrow },
              s
            ),
          g &&
            (global.React || guac.react).createElement(
          ...
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
              .CommerceCardTitle,
            a.a({ title: t, isDigitalProduct: "digital" === c, dataAids: T }, z)
          ),
          o &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Details
                .Minor,
              { style: ja.eventDate, "data-aid": T.eventDate },
              o
            ),
          (global.React || guac.react).createElement(
            W,
            ...
            k &&
              (global.React || guac.react).createElement(
                  ...
                  .CommerceCardPriceDisplay,
                {
                  ...
                  priceText: i,
                  duration: r,
                  isLinkShown: Boolean(E),
                  cardType: x,
                  dataAids: T,
                  isPriceFeatured: M,
                  strikeThroughPrice: B,
                  styles: { marginRight: b ? "xxsmall" : "0" },
                }
              ),
            b &&
              (global.React || guac.react).createElement(
          ...
          _ &&
            (global.React || guac.react).createElement(
                ...
                .CommerceCardColors,
              {
                colors: y,
                renderColorsLabel: C,
                isSingleMobileColumn: N,
                "data-aid": T.colorSwatches,
              }
            ),
          h &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Details
                .Minor,
              { style: ja.footer, "data-aid": T.footer, alert: m },
              h
            ),
          P &&
            (global.React || guac.react).createElement(
          ...
          E &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                .MoreLink,
              { category: R, section: L ? "overlay" : "default", tag: "span" },
              E
            )
        );
      return this.Block(this.merge({ children: j, style: U }, V));
    }
    function $a(e) {
      let {
        price: t,
        ...
        isLinkShown: c,
        isPriceFeatured: s,
        strikeThroughPrice: g,
        styles: p,
        ...u
      } = e;
      const d = r && { priceState: "expired" },
        h = {
          container: {
            display: "flex",
            justifyContent: o === Va ? "center" : "flex-start",
            marginBottom: c ? "xxsmall" : 0,
            "@sm": {
              marginBottom: c ? "xsmall" : 0,
              justifyContent: o === Va || o === Xa ? "center" : "flex-start",
            },
            ...p,
          },
          duration: {
            display: "inline-block",
            ":after": { content: '"|"', marginHorizontal: "xsmall" },
          },
          range: { display: "inline-block", marginRight: "xsmall" },
          original: { display: "inline-block" },
          sale: { display: "inline-block", marginLeft: "xsmall" },
        },
        m =
          g ||
          (global.React || guac.react).createElement(
            ...
            (global.React || guac.react).createElement(
              ...
              a.a(
                { key: "original", "data-aid": i.price, style: h.original },
                d,
                { children: t }
              )
            ),
        ...
        b = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          { active: !0, style: h.container },
          n &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Price,
              { children: n, featured: !0, style: h.duration }
            ),
          l &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Price,
              { children: l, featured: !0, style: h.range }
            ),
          m
        );
      return this.merge({ children: b }, u);
    }
    function Ga(e) {
      let { title: t, isDigitalProduct: r, dataAids: o = {}, ...l } = e;
      const n = (global.React || guac.react).createElement(
        (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Heading,
        a.a({ featured: !0, "data-aid": o.name }, l),
        r &&
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Icon,
            { icon: "digitalProduct" }
      ...
      return this.merge({ children: n }, l);
    }
    function qa(e) {
      let {
      ...
      const s = {
        ...
        g = {
          backgroundImage: t,
          imageData: { overlayAlpha: r },
          style: {
            ...s,
            backgroundSize: ["shrink_to_fit", "shrinkToFit"].includes(o)
              ? "contain"
              : "cover",
          },
        },
        p = {
          ...
          style: {
            ...s,
            objectFit: ["shrink_to_fit", "shrinkToFit"].includes(o)
              ? "contain"
              : "cover",
          },
        },
        ...
        h = (global.React || guac.react).createElement(
          u,
          a.a({}, d, { "data-aid": l.image })
        );
      return this.merge({ children: h }, c);
    }
    const Ya = {
        paddingTop: "small",
        display: "flex",
        alignItems: "center",
        "> :not(:last-child)": { marginRight: "xxsmall" },
      },
      Ja = { ...Ya, display: "none", "@sm": { display: "flex" } },
      Qa = { ...Ya, display: "none", "@xs-only": { display: "flex" } };
    function Ka(e) {
      let {
        colors: t,
        renderColorsLabel: a,
      ...
      return this.merge({ children: n }, o);
    }
    const er = "chevronLeft",
      tr = "chevronRight",
      ar = 16,
      rr = {
        position: "absolute",
        ...
        cursor: "pointer",
        zIndex: "2",
        svg: { filter: "drop-shadow(0px 0px 3px rgb(0 0 0 / 0.4))" },
      },
      or = {
        leftArrow: { ...rr, left: `${ar}px` },
        rightArrow: { ...rr, right: `${ar}px` },
      },
      lr = (e) => {
        const {
            Element: { Block: t, Icon: a },
          } = (global.Core || guac["@wsb/guac-widget-core"]).UX2,
          { icon: r, prevSlide: o, nextSlide: l } = e;
        return (global.React || guac.react).createElement(
          t,
          {
            category: "accent",
            id: r,
            style: r === er ? or.leftArrow : or.rightArrow,
          },
    ...
    function nr(e) {
      ...
      const h = a ? t - 2 : t,
        m = (parseFloat(Na[r] || Na.square) / 100) * h,
        b = a
          ? { borderWidth: "1px", borderStyle: "solid", borderColor: "section" }
          : null,
        y = {
        ...
        C = l.map((e, t) =>
          (global.React || guac.react).createElement(
            ...
            (global.React || guac.react).createElement(
              ...
              {
                backgroundImage: e,
                backgroundSize: ["shrink_to_fit", "shrinkToFit"].includes(n)
                  ? "contain"
                  : "cover",
                style: { height: `${m}px`, width: `${h}px` },
              }
            )
          )
        ),
        f = [
          {
            component: lr,
            position: "top",
            props: { icon: er, currentAssetIndex: p },
          },
          {
            component: lr,
            position: "bottom",
            props: { icon: tr, currentAssetIndex: p },
          },
        ],
        x = (global.React || guac.react).createElement(
          (global.React || guac.react).Fragment,
          null,
          C &&
            h &&
      ...
      return this.Block(
        this.merge(
          {
            children: x,
            style: { position: "relative", marginBottom: "small" },
          },
          d
        )
      );
    ...
    function ir(e) {
      const {
        ...
        {
          Element: { Background: g, CloseIcon: p, Container: u, Wrapper: d },
        } = (global.Core || guac["@wsb/guac-widget-core"]).UX2,
        h = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group.DrawerPanel,
          null,
          i && (global.React || guac.react).createElement(g, null),
          (global.React || guac.react).createElement(
            u,
            { maxWidth: i ? t : 0, category: a, left: n, backgroundColor: r },
            i &&
              c &&
              (global.React || guac.react).createElement(p, {
                size: l.I,
      ...
      return this.merge(e, { children: h });
    }
    function cr(e) {
      let { section: t, message: r, textProps: o = {}, ...l } = e;
      const n = {
          container: {
            backgroundColor: "section",
            paddingHorizontal: "medium",
          ...
          text: { fontColor: "lowContrast" },
        },
        i = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component.Grid,
          { inset: !0, bottom: !1, section: t },
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
            { style: n.container },
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Text,
              a.a({ tag: "span", style: n.text }, o),
              r
            )
          )
        );
      return this.merge({ children: i }, l);
    }
    function sr(e) {
      let {
        size: t = { xs: "large" },
        ribbonType: a = "default",
        dataAids: r,
        ...o
      } = e;
      const l = {},
      ...
      let c;
      "transparent" === a && ((o.category = "accent"), (o.featured = !0)),
        "roundRectangle" === a ? (c = "large") : "pill" === a && (c = "99em");
      const s = {
        position: "absolute",
        display: "block",
        backgroundColor:
          "transparent" === a ? "rgba(83, 83, 83, .6)" : "section",
        "border-radius": c,
        ...i,
        ...l.xs,
        "@sm": { ...l.sm },
      ...
      return this.DetailsMinor(
        this.merge({ style: s, category: "primary", "data-aid": r.ribbon }, o)
      );
    }
    function gr(e) {
      const {
      ...
      "start-large" === o
        ...
        ? (p = 4)
        : ((u = !0), (p = 6));
      const d = (global.React || guac.react).Children.toArray(t)
          .filter((e) => {
            const t = typeof e;
            return "object" === t
              ? (global.React || guac.react).isValidElement(e)
        ...
        h = (global.React || guac.react).createElement(
          ...
          a.a(
            ...
            (global._ || guac.lodash).pick(s, Object.keys(gt.propTypes))
          ),
          d.map((e, t) => {
            const a = e && e.type;
            if (a && a.prototype && (a === g || a.prototype instanceof g))
              return e;
            const o = 0 === t || (r && 1 === t) ? p : 12 - p;
            return (global.React || guac.react).createElement(
              g,
              { key: t, equal: u, sm: o, xs: 12, bottom: c },
              (global.React || guac.react).cloneElement(e, {
                fullBleed: l,
                roundedCorners: i,
              })
      ...
      return this.merge({ tag: "div", children: h }, s);
    }
    lr.propTypes = {
    ...
    const { getSelectedVideoProps: pr } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).utils,
      { Link: ur } = (global.Core || guac["@wsb/guac-widget-core"]).components;
    function dr(e) {
      const {
          fullBleed: t,
          mediaData: o,
        ...
        { mediaType: s = r.I } = o,
        g = {
          "@xs-only": { marginBottom: 0 },
          "@sm-only": { marginBottom: 0 },
        },
        p = { width: "100%", height: "100%" },
        u = { ...p, "@xs-only": { minHeight: "30vh" } },
        { link: d } = o,
        h = i ? { borderRadius: "xlarge", overflow: "hidden" } : {};
      let m;
      return (
        (m =
          s === r.V
    ...
    function hr(e) {
      let { style: t, roundedCorners: a, renderAsCard: r, ...o } = e;
      const l = "neutral" === this.base.category;
      return this.merge(
        {
          tag: "div",
          style: {
            backgroundColor: r && l ? "primaryLight" : "section",
            borderRadius: a ? "xlarge" : 0,
            display: "flex",
            alignItems: "center",
            minHeight: "100%",
            padding: r ? "xlarge" : 0,
      ...
      return this.merge(
        {
          ...
          style: {
            ...
            "@md": { paddingVertical: "0", paddingHorizontal: "xlarge" },
          },
        },
        e
      );
    ...
    function yr(e) {
      return this.LinkArrow(
        this.merge({ style: { marginBottom: "xlarge" } }, e)
      );
    }
    function Cr(e) {
      return this.HeadingMiddle(
        this.merge({ level: 2, style: { marginBottom: "xsmall" } }, e)
      );
    }
    function fr(e) {
      return this.Details(
        this.merge({ level: 5, style: { marginBottom: "xlarge" } }, e)
      );
    }
    function xr(e) {
      return this.merge(
    ...
    function wr(e) {
      return this.HeadingMinor(
        this.merge({ level: 4, style: { marginBottom: "xlarge" } }, e)
      );
    }
    function Tr(e) {
      return this.Text(
    ...
    function Pr(e) {
      return this.HeadingMinor(this.merge({ style: { lineHeight: "1" } }, e));
    }
    function kr(e) {
      return this.Heading(this.merge({ level: 6 }, e));
    }
    function Lr(e) {
    ...
    function Er(e) {
      ...
      if (t) {
        ...
        a = { "> p > ol": e, "> p > ul": e, "> ul": e, "> ol": e };
      }
      return this.Text(this.merge({ style: a }, e));
    }
    function Rr(e) {
      return this.ContentBasic(this.merge({ style: { ...o.a("small") } }, e));
    }
    function Mr(e) {
        ...
        this.merge(
          {
            ...
            style: { lineHeight: this.mapPropValue("lineHeightLevel", 4) },
          },
          e
        )
      );
      ...
      const a = () => {
        ...
        if (e) {
          const t = new IntersectionObserver(() => {
            (e.style.transition = "opacity 1.2s ease-in-out"),
              (e.style.opacity = "1"),
              t.disconnect();
          });
          t.observe(e);
    ...
    const { Bootstrap: zr } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      {
        renderModes: { PUBLISH: Ar },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      Br = (e) => {
        let { targetId: t, renderMode: a } = e;
        const r = a === Ar;
        return (
          (global.React || guac.react).useEffect(() => {
            if (!r) return Hr({ targetId: t });
          }, [r, t]),
          r
            ? (global.React || guac.react).createElement(zr.JS, {
                id: "FadeIn",
                script: Hr.toString(),
                props: { targetId: t },
              })
      ...
      if (t) {
        ...
        return this.merge(a, {
          ...
          children: (global.React || guac.react).createElement(
            ...
            null,
            a.children,
            (global.React || guac.react).createElement(Br, {
              targetId: e,
    ...
    const Ur = (e) => {
      const t = e.theme.constructor.config.id;
      return (
        [
          "layout9",
          "layout10",
    ...
    function Wr(e) {
      const { hasLogoBorder: t, headerTreatment: a, style: o = {} } = e,
        l = "logo" === o.font,
        n = a === r.W;
      return this.Heading(
        this.merge(
    ...
    function Nr(e) {
      return this.Heading(this.merge({ level: "5" }, e));
    }
    const {
      NONE: Fr,
      INLINE: jr,
        ...
        this.merge(
          {
            ...
            style: {
              ...
              "@xs-only": { paddingVertical: "xlarge" },
            },
          },
          e
        )
    ...
    function qr(e, t, a) {
      const r = {
        ...
        l = {
          ...
          position: "relative",
          maxWidth: "80%",
          ":before": { right: "100%", marginRight: "medium", ...o },
          ":after": { left: "100%", marginLeft: "medium", ...o },
        },
        n = { display: "block", overflow: "hidden" };
      if (t === jr)
        return (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Container,
          { style: n },
      ...
      if (t === Zr) {
        const o = { width: "100%", lineHeight: "0px" },
          l = { display: "inline-block" };
        return [
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Base,
            { key: "child", richtext: a, style: r },
            e
          ),
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
            ...
            (global.React || guac.react).createElement(
              ...
              { group: "SectionHeading", sectionHeadingHR: t, style: l }
            )
          ),
        ];
      }
      ...
      return "string" == typeof e
        ? (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Base,
            { key: "child", richtext: a, nakedElement: !0, style: r },
            e
          )
        : e;
    }
    function Yr(e) {
      let { children: t, sectionHeadingHR: a = Fr, richtext: r, ...o } = e;
      return this.Heading(
        this.merge(
          {
            level: 2,
            ...
            children: qr(t, a, r),
            style: { lineHeight: "1.4", marginTop: 0, marginBottom: "xlarge" },
          },
          o
        )
      );
    ...
    function Jr(e) {
      ...
      return this.HR(this.merge({ style: r[t] || {} }, a));
    }
    function Qr(e) {
      return this.Heading(
        this.merge(
    ...
    function ro(e) {
      return this.merge(
        { tag: "form", "aria-live": "polite", style: { marginBottom: "0" } },
        e
      );
    }
    function oo(e) {
    ...
    function lo(e) {
      return this.Error(this.merge({ style: { marginTop: "xxsmall" } }, e));
    }
    function no(e) {
      let { hasNav: t, pipe: a, inline: r, ...o } = e;
      return this.merge(
        {
          style: {
            display: "flex",
    ...
    function io(e) {
      return this.merge({ style: { "> div": { paddingVertical: 0 } } }, e);
    }
    function co(e) {
      return this.merge({ style: { position: "relative" } }, e);
    }
    const { Z_INDEX_NAV_DRAWER: so } = (
      global.Core || guac["@wsb/guac-widget-core"]
    ).constants.layers;
    function go(e) {
      let { category: t = "accent", left: a = !0, ...r } = e;
      return this.merge(
        {
          category: t,
          left: a,
    ...
    function po(e) {
      return this.List(this.merge({ role: "menu" }, e));
    }
    function uo(e) {
    ...
    function mo(e) {
      return this.NavigationDrawerLink(this.merge({ active: !0 }, e));
    }
    function bo(e) {
    ...
    function yo(e) {
      return this.NavigationDrawerSubLink(this.merge({ active: !0 }, e));
    }
    function Co(e) {
      return this.Input(
        this.merge(
    ...
    function wo(e) {
      ...
      const n = { left: a ? 0 : "unset", right: a ? "unset" : 0 };
      return this.Block(
        this.merge(
          {
            category: t,
    ...
    function vo(e) {
      return this.CloseIcon(
        this.merge(
          { style: { position: "absolute", top: "small", right: "small" } },
          e
        )
      );
    }
    ...
    function Eo(e) {
      return this.ContentText(this.merge({ style: { width: "100%" } }, e));
    }
    function Ro(e) {
    ...
    function Mo(e) {
      const t =
        "about1" === this.base.widgetPreset ? { alignSelf: "center" } : {};
      return this.Button(this.merge({ style: t }, e));
    }
    function So(e) {
      return this.Wrapper(
        this.merge(
    ...
    function Bo(e) {
      return this.ContentCardButton(
        this.merge({ style: { marginBottom: "0px !important" } }, e)
      );
    }
    function Io(e) {
      return this.merge({ tag: "div" }, e);
    ...
    function Do(e) {
      return this.merge({ tag: "nav" }, e);
    }
    function Uo(e) {
      return this.Link(
        this.merge({ typography: "NavAlpha", style: { display: "block" } }, e)
      );
    }
    function Wo(e) {
      return this.NavLink(this.merge({ active: !0 }, e));
    }
    function Oo(e) {
      return this.Link(
        this.merge(
          {
            style: { display: "inline-block", paddingVertical: "xxsmall" },
    ...
    function _o(e) {
      return this.NavMenuLink(this.merge({ active: !0 }, e));
    }
    const No = {
    ...
    function Fo(e) {
      return this.NavLink(this.merge({ style: No }, e));
    }
    function jo(e) {
      return this.NavLinkActive(this.merge({ style: No }, e));
    }
    function Zo(e) {
    ...
    function Yo(e) {
      return this.Nav(
        this.merge(
          {
            style: { "@xs-only": { display: "flex", flexDirection: "column" } },
          },
          e
        )
      );
        ...
        this.merge(
          {
            ...
            style: {
              ...
              "@xs-only": { paddingVertical: "xxsmall" },
            },
          },
          e
        )
    ...
    function Ko(e) {
      return this.Heading(
        this.merge(
          { typography: "HeadingDelta", style: { marginBottom: "medium" } },
          e
        )
      );
    }
    function el(e) {
      let { level: t = 0, children: a, ...r } = e;
      t++;
      return this.List(
        this.merge(
          {},
          {
            children: (global.React || guac.react).Children.map(a, (e) =>
              (global.React || guac.react).isValidElement(e)
                ? (global.React || guac.react).cloneElement(e, { level: t })
                : e
            ),
            level: t,
            style: {
              ...{
                2: { marginTop: "medium", marginLeft: "small" },
                3: { marginTop: "xsmall", marginLeft: "small" },
              }[t],
            },
          },
          r
    ...
    function rl(e) {
      return this.NavVerticalLink(this.merge({ active: !0 }, e));
    }
    function ol(e) {
      return this.List(this.merge({ style: { textAlign: "center" } }, e));
    }
    function ll(e) {
      return this.ListItemInline(e);
    }
    function nl(e) {
      return this.Link(this.merge({ typography: "NavGamma" }, e));
    }
    function il(e) {
      return this.NavHorizontalLink(this.merge({ active: !0 }, e));
    }
    function cl(e) {
      return this.List(
        this.merge(
          { style: { marginLeft: "medium", paddingTop: "xxsmall" } },
          e
        )
      );
    }
    function sl(e) {
      return this.NavLink(
        this.merge({ style: { display: "flex", alignItems: "center" } }, e)
      );
    }
    function gl(e) {
    ...
    function pl(e) {
      return this.Block(
        this.merge(
          {
            role: "banner",
            style: { backgroundColor: "section", paddingVertical: "xxsmall" },
          },
          e
        )
      );
    ...
    function ml(e) {
      return this.merge(
        {
          style: {
            "@xs": { borderBottomRightRadius: "10%" },
            "@md": { right: 0, left: "unset", borderBottomLeftRadius: "10%" },
            zIndex: 1200,
            display: "flex",
            cursor: "pointer",
            alignItems: "center",
    ...
    const { themeConstants: fl, renderModes: xl } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).constants,
      { DISPLAY: wl } = xl;
    function Tl(e) {
      let { renderMode: t, sidebarWidth: a, ...r } = e;
      const o = t === wl || "PREVIEW_RENDER_MODE" === t;
      return this.merge(
        {
          tag: "nav",
          style: {
            ...
            height: "100%",
            width: a,
            zIndex: fl.SIDELINE_SIDEBAR_ZINDEX,
            transition: "transform 0.4s ease-in-out",
            boxShadow: "0 0 4px 0px rgba(0,0,0,0.2)",
            position: "fixed",
            "@md": { display: "block", transform: "translateX(-150vw)" },
            "@lg": {
              display: "block",
              transition: "none",
    ...
    function Pl(e) {
      return this.List(
        this.merge({ style: { paddingLeft: 0, listStyleType: "none" } }, e)
      );
    }
    const { themeConstants: kl } = (
      global.Core || guac["@wsb/guac-widget-core"]
    ).constants;
    function Ll(e) {
      let { sidebarWidth: t, ...a } = e;
      const { renderMode: r } = this.base;
      return this.merge(
        {
          tag: "div",
          style: {
            ...
            maxWidth: 0,
            overflowX: "hidden",
            zIndex: kl.SIDELINE_SIDEBAR_ZINDEX,
          },
        },
        a
      );
    ...
    function El(e) {
      return this.List(
        this.merge({ style: { paddingHorizontal: "xlarge", width: "100%" } }, e)
      );
    }
    function Rl(e) {
      return this.ListItem(
            ...
            children: [
              s &&
                (global.React || guac.react).createElement(
                  (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                    .Text,
                  { key: "range", children: s, style: d.rangeLabel }
                ),
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                  .Price,
              ...
              g &&
                (global.React || guac.react).createElement(
                    ...
                    .Price,
                  {
                    ...
                    style: d.sale,
                    priceState: "alert",
                    children: Ml(u) ? u.display : u,
                  }
                ),
            ],
            style: { marginTop: "xsmall", textAlign: "center" },
          },
          c
        )
      );
    ...
    function Hl(e) {
      ...
      const d = t && t.length ? t[0].large_url : p,
        h = o || d;
      if (!h) return null;
      const m = Bt(h, "/:/rs=w:{width},h:{height},cg:false,m"),
        b = {
          outer: {
                ...
                children: [
                  ...
                  a &&
                    ...
                    (global.React || guac.react).createElement(
                      (global.Core || guac["@wsb/guac-widget-core"]).UX2.Group
                        .Product.Banner,
                      { key: "banner", getStyles: l, "data-aid": i.saleBanner },
                      a.text
                    ),
                ],
              },
        ...
        this.merge(
          {
            style: {
              ...
              right: "0px",
              width: "auto",
              paddingVertical: t({ saleBannerPaddingVertical: !0 }) || "xsmall",
              paddingHorizontal: "xsmall",
    ...
    function Al(e) {
      let { product: t, getStyles: a = () => !1, ...r } = e;
      const o = "digital" === t.product_type,
        ...
        n = {
          ...
          text: { textAlign: "center", ...(l && { fontSize: l }) },
          digitalProductIcon: {
            marginRight: "xxsmall",
              ...
              o &&
                (global.React || guac.react).createElement(
                  ...
                  (global.React || guac.react).createElement(
                    (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                      .Icon,
                    { icon: "digitalProduct", style: n.digitalProductIcon }
                  )
                ),
              t.name
            ),
    ...
    function Bl(e) {
      let { getStyles: t = () => !1, shipping: a = !1, ...r } = e;
      const o = t({ isOptionOrFreeShipping: !0 }),
        l = {
          group: "Product",
          groupType: "Label",
          style: {
      ...
      return !0 === a
        ? this.DetailsMinor(this.merge(l, r))
        : this.Details(this.merge(l, r));
    }
    function Il(e) {
      return this.Container(
        this.merge(
    ...
    function Xl(e) {
      return this.IconSearch(
        this.merge(
          { style: { color: "highContrast", marginLeft: "xsmall", zIndex: 1 } },
          e
        )
      );
    }
    function Dl(e) {
      return this.InputSearch(
        this.merge({ style: { ":focus": { boxShadow: "none" } } }, e)
      );
    }
    function Ul(e) {
      return this.Group(
    ...
    function Wl(e) {
      return this.Address(
        this.merge(
          { style: { display: "block", "@sm": { display: "inline-block" } } },
          e
        )
      );
    }
    function Ol(e) {
      return this.Pipe(
        this.merge(
          { style: { display: "inline-block", marginHorizontal: "small" } },
          e
        )
      );
    }
    function _l(e) {
      return this.Phone(this.merge({ style: { display: "inline-block" } }, e));
    }
    function Nl(e) {
      return e;
    }
    function Fl(e) {
      let { align: t = "left", ...a } = e;
      return this.Heading(
        this.merge(
          {
            ...
            section: "default",
            active: !0,
            style: { textAlign: t, marginBottom: "xxsmall" },
          },
          a
        )
      );
    ...
    function Gl(e) {
      return this.Price(this.merge({ section: "overlay" }, e));
    }
    function ql(e) {
    ...
    function Yl(e) {
      return this.CommerceOverlayMoreLink(
        this.merge({ style: { marginLeft: "xsmall" } }, e)
      );
    }
    function Jl(e) {
      return this.CommerceOverlayWrapper(
    ...
    function en(e) {
      return this.Text(
        this.merge({ typography: "DetailsBeta", section: "default" }, e)
      );
    }
    function tn(e) {
      return this.CommerceOverlayPrice(
        this.merge({ typography: "DetailsBeta" }, e)
      );
    }
    function an(e) {
      return this.Block(
        ...
        this.merge(
          {
            typography: "BodyAlpha",
            featured: !0,
            style: { marginBottom: "xsmall", textAlign: t },
          },
          a
        )
      );
    ...
    function ln(e) {
      return this.Price(this.merge({ typography: "DetailsAlpha" }, e));
    }
    function nn(e) {
      return this.Wrapper(
        this.merge(
    ...
    function cn(e) {
      return this.Button(this.merge({ size: "small" }, e));
    }
    function sn(e) {
      return this.Block(
        this.merge(
          {
            style: {
              ...
              "@sm": { gridColumnGap: this.mapPropValue("spacing", "medium") },
            },
          },
          e
        )
    ...
    var bn = (e) => {
      let { fill: t, shape: a = dn.SQUARE } = e;
      return t === hn.OPEN
        ? {}
        : (dn[a] ||
            (console.error(`Button: shape type of ${a} is not valid.`),
            (a = dn.SQUARE)),
          { style: mn[a]() });
    };
    const {
        buttons: { fills: yn, colors: Cn },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      fn = {
        PRIMARY: {
          color: "action",
      ...
      wn = { active: {}, default: {}, disabled: { opacity: "0.4" } },
      Tn = {
        PRIMARY: {
          color: "highlight",
      ...
      vn = { active: {}, default: {}, disabled: { opacity: "0.4" } };
    const Pn = {
      [yn.NONE]: () => ({}),
      [yn.SOLID]: function (e, t) {
        const a = {
          active: { backgroundColor: fn[t].bgColorActive },
          default: {
            backgroundColor: fn[t].bgColorDefault,
            ":hover": { backgroundColor: fn[t].bgColorDefaultHover },
          },
          disabled: {
            backgroundColor: fn[t].bgColorDefault,
            opacity: "0.4",
            ":active": { backgroundColor: fn[t].bgColorDefault },
          },
        };
        return { color: fn[t].color, ...a[e] };
      },
      [yn.GHOST]: function (e, t, a) {
        return {
          ...
          ...wn[e],
          ":hover": {
            color: xn[t].colorHover,
            backgroundColor: xn[t].bgColorHover,
            borderColor: xn[t].borderColorHover,
          },
        };
      },
      [yn.OPEN]: function (e, t) {
        return {
          backgroundColor: "transparent",
          color: Tn[t].color,
          alignItems: "flex-end",
          ...vn[e],
          ":hover": { color: Tn[t].colorHover },
          ":active": { color: Tn[t].colorActive },
        };
      },
    };
    var kn = (e) => {
      ...
      return (
        yn[t] ||
          (console.error(`Button: fill type of ${t} is not valid.`),
          (t = yn.SOLID)),
        { style: Pn[t](r, a, o) }
      );
    };
    const {
      buttons: { shadows: Ln, fills: En, colors: Rn },
    } = (global.Core || guac["@wsb/guac-widget-core"]).constants;
    const Mn = {
      [Ln.NONE]: () => ({}),
      [Ln.SHADOW1]: function () {
      ...
      [Ln.SHADOW2]: function (e) {
        const t = this.mapPropValue(
          "backgroundColor",
          {
            PRIMARY: { bgColor: "action" },
            HIGHCONTRAST: { bgColor: "actionContrast" },
          }[e].bgColor
        );
        return {
          borderStyle: "solid",
    ...
    function Sn(e) {
      let { fill: t, shadow: a = Ln.NONE, color: r = Rn.PRIMARY } = e;
      return t !== En.SOLID && a !== Ln.NONE
        ? (console.warn("Button: shadow can only be applied to fills.SOLID."),
          {})
        : Ln[a]
        ? { style: Mn[a].call(this, r) }
        : (console.error(`Button: shadow type of ${a} is not valid.`), {});
    }
    const {
        buttons: { decorations: Hn, fills: zn },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      An = {
        position: "unset",
        opacity: "unset",
    ...
    const In = {
      ...
      [Hn.LINES]: function (e) {
        ...
        return {
          style: {
            alignItems: "center",
            ":before": { marginRight: "xsmall", ...r },
            ":after": { marginLeft: "xsmall", ...a, ...r },
          },
        };
      },
    ...
    function Vn(e) {
      const { decoration: t = Hn.NONE } = e;
      return Hn[t]
        ? In[t].call(this, e)
        : (console.error(`Button: decoration type of ${t} is not valid.`), {});
    }
    const {
      buttons: { shapes: Xn, decorations: Dn, fills: Un },
    } = (global.Core || guac["@wsb/guac-widget-core"]).constants;
    var Wn = (e) => {
      let { fill: t, decoration: a, shape: r, size: o = "default" } = e,
        l = "default";
      t === Un.OPEN
        ? (l = "open")
        : a === Dn.LINES
        ...
        : r === Xn.PILL && (l = "pill");
      const n = {
        default: { small: "small", default: "large", large: "xlarge" },
        pill: { small: "medium", default: "xlarge", large: "xlarge" },
        lines: {
          small: r === Xn.PILL ? "medium" : "small",
          default: r === Xn.PILL ? "medium" : "small",
          large: r === Xn.PILL ? "medium" : "small",
        },
        open: { small: 0, default: 0, large: 0 },
      };
      return {
        style: {
          small: {
    ...
    function On(e) {
      ...
      return this.merge(
        ...
        a,
        { style: u },
        ...[Wn, bn, kn, Vn, Sn].map((e) => e.call(this, { ...g, ...d }))
      );
    }
    function _n(e) {
      let { children: t, ...a } = e;
      const { state: r = "default", size: o = "default" } = a,
        n = a.href || a.target || "link" === a.theme ? "a" : "button",
        i = "a" === n && "_blank" === a.target ? { rel: "noopener" } : {},
        c = "small" === o ? "small" : "default",
        { icon: s, iconLeft: g = !0, iconSize: p = c, ...u } = On.call(this, a),
        d = a.btnAddon
          ? (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                .Element,
          ...
          : null,
        h = {
          default: { icon: l.B, adjustment: "-xsmall" },
          small: { icon: l.b, adjustment: "-xxsmall" },
        },
        m =
          "OPEN" !== u.fill
            ? {
        ...
        C = (global.React || guac.react).createElement(
          ...
          (global.React || guac.react).createElement(
            ...
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                .Element,
              { className: "iconText", style: { ...y.common, ...y.text } },
              t
            )
          )
        );
    ...
    const Nn = { outline: "none", boxShadow: "inset 0 0 0 1px currentColor" };
    function Fn(e) {
      let {
        convertToAbsolute: t,
        href: a,
      ...
      if (
        (t && a && 0 !== a.indexOf("http") && (a = `https://${o}${a}`),
        ...
        n.props = {
          ...e,
          style: { "@sm-only": t, "@xs-only": t, ...(e.style || {}) },
        };
      }
      var i;
    ...
    function Zn(e) {
      ...
      return (
        ...
        !0 === t ? this.MoreLinkBackward(a) : this.MoreLinkForward(a)
      );
    }
    function $n(e) {
      return this.Link(
        this.merge({ style: { textDecoration: "underline" } }, e)
      );
    }
    function Gn(e) {
      let { refCallback: t, ...a } = e;
      return this.merge(
        {
          tag: "input",
    ...
    function Yn(e) {
      ...
      const { Label: c, Input: s } = (
          global.Core || guac["@wsb/guac-widget-core"]
        ).UX2.Element,
        g = { fontSize: "12px", top: "8px", color: "inputHighlight", ...n },
      ...
      return this.merge(
        {
          ...
          children: (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Icon,
            { icon: "chevronLeft", "data-edit-interactive": !0 }
          ),
        },
        e
      );
      ...
      return this.merge(
        {
          ...
          children: (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Icon,
            { icon: "chevronRight", "data-edit-interactive": !0 }
          ),
        },
        e
      );
    ...
    function ai(e) {
      return this.Button(this.merge({ fullWidth: !0 }, e));
    }
    function ri(e) {
      let { skin: t, ...a } = e;
      const r = {
        whatsapp: {
          style: {
            ...
            ":hover": { backgroundColor: "brandLividHover" },
          },
          icon: "whatsApp",
          typography: !1,
        },
      };
      return this.Button(this.merge({ ...r[t] }, a));
    }
    const oi = {
        section: "overlay",
        category: "accent",
        style: {
          ...
          color: "highContrast",
          fontSize: "small",
          "@md": { paddingVertical: "xsmall", paddingHorizontal: "xxsmall" },
        },
      },
      li = {
        style: {
          ...
          ":hover": { backgroundColor: "section" },
          ":active": { backgroundColor: "section" },
        },
      };
    function ni(e) {
      return this.ButtonPrevious(this.merge({ style: { left: 0 } }, oi, li, e));
    }
    function ii(e) {
      return this.ButtonNext(this.merge({ style: { right: 0 } }, oi, li, e));
    }
    const ci = {
      style: {
        backgroundColor: "transparent",
        ...
        "@sm": {
          ":hover": { backgroundColor: "sectionOverlaySoft" },
          ":active": { backgroundColor: "sectionOverlaySoft" },
        },
      },
    };
    function si(e) {
      return this.ButtonPrevious(this.merge(oi, ci, e));
    }
    function gi(e) {
      return this.ButtonNext(this.merge(oi, ci, e));
    }
    function pi(e) {
      let { label: t, style: r, textProps: o = {}, ...l } = e;
      if (!t && !o.children)
        return this.merge(
    ...
    function ui(e) {
      return this.merge({ tag: "input", type: "radio" }, e);
    }
    function di(e) {
      let {
        children: t,
      ...
      return this.merge(
        {
          ...
          style: {
            ...
            position: "relative",
            ...{
              default: { borderColor: "input" },
              error: { borderColor: "inputError" },
              disabled: { opacity: ".2" },
            }[l ? "disabled" : n],
          },
        },
    ...
    function bi(e) {
      return this.merge({ tag: "option" }, e);
    }
    function yi(e) {
      return this.merge(
        {
    ...
    const Ci = { style: { lineHeight: "0" }, typography: "NavAlpha" };
    function fi(e) {
      return this.Link(this.merge({ ...Ci }, e));
    }
    function xi(e) {
      return this.Icon(this.merge({ ...Ci }, e));
    }
    function wi(e) {
      return this.Button(this.merge({ style: { margin: 0 } }, e));
    }
    function Ti(e) {
      let {
        icon: t = "chevronLeft",
      ...
      const i = r
          ? [
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                  .Element,
                { key: "span", style: { verticalAlign: "middle" }, children: r }
              ),
            ]
          : [],
        c = (global.React || guac.react).createElement(
    ...
    function vi(e) {
      let { icon: t, right: a, rotate: r, iconSize: o, ...l } = e;
      const n = "LinkAlpha";
      return t
        ? this.LinkIcon(
            this.merge(
              { icon: t, right: a, rotate: r, iconSize: o, typography: n },
              l
            )
          )
        : this.Link(this.merge({ typography: n }, l));
    }
    function Pi(e) {
      let { expanded: t, ...a } = e;
      const r = t ? "minus" : "plus";
      return this.MoreLink(this.merge({ icon: r, "aria-expanded": t }, a));
    }
    function ki(e) {
      return this.MoreLink(this.merge({ icon: "chevronLeft" }, e));
    }
    function Li(e) {
      return this.MoreLink(this.merge({ icon: "chevronRight", right: !0 }, e));
    }
    function Ei(e) {
      let { expanded: t, ...a } = e;
      const r = t ? 180 : 0;
      return this.MoreLink(
        this.merge({ icon: "chevronDown", rotate: r, right: !0 }, a)
      );
    }
    function Ri(e) {
      return this.Link(this.merge({ typography: "LinkAlpha" }, e));
    }
    function Mi(e) {
      return this.merge(
        {
    ...
    function Si(e) {
      return this.Dot(this.merge({ style: { background: "currentColor" } }, e));
    }
    function Hi(e) {
      return this.Link(
        this.merge(
    ...
    function _i(e) {
      return this.Wrapper(this.merge({ style: { display: "block" } }, e));
    }
    function Ni(e) {
      return this.Embed(e);
    }
    function Fi(e) {
      ...
      return (
        t ||
          ((r["@sm"] = { width: "smContainer" }),
          (r["@md"] = { width: "mdContainer" }),
          (r["@lg"] = { width: "lgContainer" }),
          (r["@xl"] = { width: "xlContainer" })),
        this.merge({ tag: "div", style: r }, a)
      );
    }
    function ji(e) {
      return this.Container(this.merge(e, { fluid: !0 }));
    }
    function Zi(e) {
        ...
        this.merge(
          {
            style: {
              ...
              display: "flex",
              flexDirection: "column",
              "@md": { flexWrap: "nowrap", flexDirection: "row" },
            },
          },
          e
        )
        ...
        this.merge(
          {
            style: {
              ...
              flexDirection: "column",
              paddingVertical: "medium",
              "> div:nth-child(2)": { paddingTop: "medium" },
              "@md": {
                flexDirection: "row",
    ...
    function tc(e) {
      let { className: t = "", ...a } = e;
      const { SVG: r } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
          .Element,
        o = {
          viewBox: "0 0 64 64",
          fill: "currentColor",
      ...
      return this.merge(
        {
          ...
          children: (global.React || guac.react).createElement(
            ...
            (global.React || guac.react).createElement(
              r,
              o,
              (global.React || guac.react).createElement("circle", l)
            ),
            (global.React || guac.react).createElement(
              r,
              o,
    ...
    const ac = (global.React || guac.react).createElement(
        "g",
        null,
        (global.React || guac.react).createElement("path", {
          fill: "evenodd",
      ...
      rc = (global.React || guac.react).createElement(
        "g",
        null,
        (global.React || guac.react).createElement("path", {
          d: "M19.3748 0.914408C17.0406 -0.544155 13.967 -0.197654 11.2308 1.52588C8.49389 -0.197654 5.42186 -0.544155 3.08767 0.914408C-0.599906 3.21843 -1.04832 9.15459 2.08731 14.1719C4.39948 17.8717 8.01369 20.0388 11.2308 19.9988C14.448 20.0388 18.063 17.8717 20.3744 14.1719C23.51 9.15459 23.0624 3.21925 19.3748 0.914408ZM3.7823 13.1129C3.12273 12.057 2.636 10.9425 2.33516 9.79949C2.05225 8.72249 1.94626 7.67157 2.02208 6.6761C2.16231 4.82212 2.91646 3.37823 4.14674 2.60941C5.37702 1.84058 7.00598 1.79574 8.73359 2.48222C8.99367 2.58576 9.2513 2.70561 9.50567 2.8385C8.58521 3.67255 7.73893 4.67536 7.01984 5.82656C5.1145 8.87576 4.53482 12.2633 5.19929 14.9693C4.67831 14.4075 4.20381 13.7863 3.78312 13.112L3.7823 13.1129ZM20.1265 9.79949C19.8257 10.9425 19.3389 12.057 18.6794 13.1129C18.2579 13.7871 17.7842 14.4075 17.2632 14.9693C17.8576 12.5462 17.4556 9.57855 15.9971 6.79513C15.8943 6.59946 15.6579 6.53424 15.4704 6.65164L10.9292 9.48886C10.7555 9.5973 10.7025 9.8264 10.811 10.0001L11.4771 11.0656C11.5855 11.2393 11.8146 11.2923 11.9882 11.1839L14.9315 9.34456C15.0301 9.62747 15.1182 9.912 15.194 10.1982C15.4769 11.2752 15.5829 12.3261 15.5071 13.3216C15.3668 15.1755 14.6127 16.6194 13.3824 17.3883C12.7677 17.7723 12.0543 17.9753 11.2781 17.9973C11.261 17.9973 11.2439 17.9973 11.2276 17.9973C11.2129 17.9973 11.1982 17.9973 11.1844 17.9973C10.4082 17.9753 9.69401 17.7723 9.07928 17.3883C7.849 16.6194 7.09403 15.1747 6.95462 13.3216C6.87961 12.3261 6.98478 11.2752 7.26769 10.1982C7.56853 9.05513 8.05526 7.94062 8.71484 6.88481C9.37441 5.82901 10.1628 4.90283 11.0588 4.13156C11.9026 3.40513 12.8011 2.84992 13.7289 2.48059C15.4565 1.79411 17.0855 1.83895 18.3158 2.60778C19.546 3.3766 20.301 4.8213 20.4404 6.67447C20.5154 7.66994 20.4102 8.72086 20.1273 9.79786L20.1265 9.79949Z",
      ...
      oc = (global.React || guac.react).createElement(
        (global.React || guac.react).Fragment,
        null,
        (global.React || guac.react).createElement(
          "defs",
          null,
          (global.React || guac.react).createElement("path", {
            d: "M3,0 L89,0 C90.6568542,-3.04359188e-16 92,1.34314575 92,3 L92,38 L0,38 L0,3 C-2.02906125e-16,1.34314575 1.34314575,3.04359188e-16 3,0 Z",
            id: "path-1",
          }),
          (global.React || guac.react).createElement(
            "filter",
            ...
            (global.React || guac.react).createElement("feOffset", {
              dx: "0",
              dy: "0",
              in: "SourceAlpha",
              result: "shadowOffsetOuter1",
            }),
            (global.React || guac.react).createElement("feGaussianBlur", {
              stdDeviation: "1.5",
              in: "shadowOffsetOuter1",
              result: "shadowBlurOuter1",
            }),
            (global.React || guac.react).createElement("feColorMatrix", {
        ...
        (global.React || guac.react).createElement(
          ...
          (global.React || guac.react).createElement(
            "g",
            { id: "mixin/trustmark/shadow" },
            (global.React || guac.react).createElement(
              "g",
              { id: "bg" },
              (global.React || guac.react).createElement("use", {
                fill: "black",
                fillOpacity: "1",
                filter: "url(#filter-2)",
              }),
          ...
          (global.React || guac.react).createElement("path", {
            d: "M2,0 L90,0 C91.1045695,-2.02906125e-16 92,0.8954305 92,2 L92,38 L0,38 L0,2 C-1.3527075e-16,0.8954305 0.8954305,2.02906125e-16 2,0 Z",
            id: "bg",
            fill: "#FFFFFF",
          }),
          (global.React || guac.react).createElement(
    ...
    const {
      ...
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants.breakpoints,
      {
        ...
        .containerWidths,
      { getImageDimensions: fc, getOriginalImageDimensions: xc } = (
        global.Core || guac["@wsb/guac-widget-core"]
    ...
    function Rc() {
      ...
      if (!St(e) || (!t?.imageUrl && !t?.image))
        return r ? { ...c, ...Ec(e) } : { src: e, ...c };
      const { width: s = Number.MAX_SAFE_INTEGER, height: g } = xc(t),
        p = fc(t),
        { outputWidth: u, outputHeight: d } = t,
        { aspectRatio: h } = p,
        m = !kc(t.width) && parseInt(t.width || 0, 10),
        b = !kc(t.height) && parseInt(t.height || 0, 10),
        y = Boolean(m || b),
        C = r &&
          o && { srcSet: Vt(p, Tc).join(", "), sizes: Lc(Tc).join(", ") },
        f = r ? { ...Ec(e), ...C } : { src: e };
      if (l) return { ...f, ...c };
      const x = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Base,
          a.a({}, f, c)
        ),
        w = (function () {
          const e =
            ...
            (arguments.length > 0 && void 0 !== arguments[0]
              ...
              : 0);
          return [
            { max: wc - 1, imageMax: wc - e, width: hc },
            { min: wc, max: nc, imageMax: nc - e, width: hc },
            { min: ic, max: cc, width: mc },
            { min: sc, max: gc, width: bc },
            { min: pc, max: uc, width: yc },
            { min: dc, width: Cc },
          ];
        })(i),
        T = (e) =>
          n
            ? r
              ? { "data-lazyimg": !0, "data-srcsetlazy": e, ...C }
              : { srcSet: e }
            : {};
      if (!u && !d) {
        const t = [];
        ...
        return (
          w.some((o) => {
            let { min: l, max: n, imageMax: i, width: c } = o;
            const g = "100%" === c ? i || n : c;
            if (
              ((r = Zt.reduce((t, a) => {
                const r = a * g,
            ...
            const p = s < n,
              u =
                l && n && !p
                  ? `(min-width: ${l}px) and (max-width: ${n}px)`
                  : l
                  ? `(min-width: ${l}px)`
                  : `(max-width: ${n}px)`;
            return (
        ...
        return (
          w.some((o) => {
              ...
              ((r = Zt.reduce((e, a) => {
                ...
                const o = r / u,
                  ...
                  i = {
                    ...t,
                    ...(y
                      ? { width: Math.round(m * o), height: Math.round(b * o) }
                      : {}),
                    outputWidth: r,
                    outputHeight: n,
                  },
                  c = a > 1 ? ` ${a}x` : "";
                return e.concat(`${It(i)}${c}`);
              }, []).join(", ")),
              0 === r.length)
            )
              return !1;
            const p = u < i,
              h =
                n && i && !p
                  ? `(min-width: ${n}px) and (max-width: ${i}px)`
                  : n
                  ? `(min-width: ${n}px)`
                  : `(max-width: ${i}px)`;
            return (
      ...
      const P = Zt.map((e) => {
        ...
        return `${It({
          ...t,
          ...(y ? { width: Math.round(m * e), height: Math.round(b * e) } : {}),
          outputWidth: r,
          outputHeight: a,
        })}${o}`;
      })
      ...
      if (d > vc) {
        const e = Zt.map((e) => {
            ...
            return `${It({
              ...t,
              ...(y
                ? { width: Math.round(m * e), height: Math.round(b * e) }
                : {}),
              outputWidth: r,
              outputHeight: a,
            })}${o}`;
          ...
          r = [
            e.length &&
              (global.React || guac.react).createElement(
                "source",
                a.a({ key: "mobile", media: `(max-width: ${wc - 1}px)` }, T(e))
              ),
            P.length &&
              (global.React || guac.react).createElement(
                "source",
                a.a({ key: "desktop", media: `(min-width: ${wc}px)` }, T(P))
              ),
          ].filter(Boolean);
        return 1 === r.length
          ? { ...f, ...T(e || P), ...c }
    ...
    const Mc = {
      ...
      Sc = (global.React || guac.react).createElement("path", {
        fillRule: "evenodd",
    ...
    const zc = (global.React || guac.react).createElement("path", {
        d: "M12 4a8 8 0 00-2.915 15.452c-.07-.633-.134-1.606.027-2.297.146-.625.938-3.977.938-3.977s-.239-.479-.239-1.188c0-1.112.645-1.942 1.448-1.942.682 0 1.012.512 1.012 1.127 0 .686-.437 1.712-.663 2.663-.188.796.4 1.446 1.185 1.446 1.422 0 2.515-1.5 2.515-3.664 0-1.915-1.377-3.254-3.342-3.254-2.276 0-3.612 1.707-3.612 3.471 0 .688.265 1.425.595 1.826a.24.24 0 01.056.23c-.061.252-.196.796-.222.907-.035.146-.116.177-.268.107-1-.465-1.624-1.926-1.624-3.1 0-2.523 1.834-4.84 5.286-4.84 2.775 0 4.932 1.977 4.932 4.62 0 2.757-1.739 4.976-4.152 4.976-.81 0-1.572-.421-1.833-.919l-.498 1.902c-.181.695-.669 1.566-.995 2.097A8 8 0 1012 4z",
      }),
      Ac = (global.React || guac.react).createElement(
        "g",
        null,
        (global.React || guac.react).createElement("path", {
          d: "M12.002 20.003a8.002 8.002 0 100-16.003 8.002 8.002 0 000 16.003z",
          fill: "#fff",
        }),
        (global.React || guac.react).createElement("path", {
          d: "M12.007 4C7.585 4 4 7.579 4 11.993a7.996 7.996 0 005.087 7.448c-.072-.632-.131-1.605.027-2.296.145-.625.935-3.974.935-3.974s-.237-.48-.237-1.184c0-1.112.646-1.94 1.45-1.94.685 0 1.015.512 1.015 1.124 0 .684-.435 1.71-.666 2.665-.19.796.402 1.447 1.186 1.447 1.424 0 2.518-1.5 2.518-3.658 0-1.914-1.378-3.25-3.348-3.25-2.28 0-3.618 1.704-3.618 3.467 0 .684.264 1.421.593 1.822a.238.238 0 01.053.23c-.06.25-.198.797-.224.909-.033.144-.119.177-.27.105-1.002-.467-1.628-1.921-1.628-3.099 0-2.52 1.832-4.835 5.292-4.835 2.774 0 4.936 1.973 4.936 4.618 0 2.757-1.74 4.974-4.152 4.974-.81 0-1.575-.421-1.832-.921l-.5 1.901c-.179.697-.666 1.566-.996 2.099a8.06 8.06 0 002.372.355C16.415 20 20 16.421 20 12.007 20.013 7.579 16.428 4 12.007 4z",
          fill: "#E60023",
        })
      ),
      Bc = (global.React || guac.react).createElement("path", {
      ...
      Ic = (global.React || guac.react).createElement(
        "g",
        null,
        (global.React || guac.react).createElement("path", {
          d: "M20.624 8.034c.376 1.451.376 4.48.376 4.48s0 3.027-.376 4.478a2.258 2.258 0 01-1.591 1.62C17.628 19 12 19 12 19s-5.629 0-7.032-.389a2.258 2.258 0 01-1.592-1.619C3 15.541 3 12.513 3 12.513s0-3.028.376-4.479c.207-.8.817-1.431 1.592-1.645C6.37 6 12 6 12 6s5.629 0 7.032.389a2.294 2.294 0 011.592 1.645z",
          fill: "#FF0000",
        }),
        (global.React || guac.react).createElement("path", {
          d: "M10.16 15.86l4.704-3-4.705-3v6z",
          fill: "#fff",
        })
      ),
      Vc = (global.React || guac.react).createElement("path", {
        fillRule: "evenodd",
        d: "M4 4L10.2524 12.907L4 20H5.43876L10.8867 13.7961L15.2465 20H20L13.5306 10.802L19.4692 4H18.0672L12.8796 9.89336L8.77364 4H4ZM5.92281 5.02962L15.9107 19.0194H18.0873L8.08596 5.02962H5.92281Z",
      }),
      Xc = (global.React || guac.react).createElement("path", {
      ...
      Nc = (global.React || guac.react).createElement(
        ...
        (global.React || guac.react).createElement("path", {
          d: "M16.2143 6.53574H14.9286V10.3929H16.2143V6.53574Z",
          fill: "#9146FF",
        }),
        (global.React || guac.react).createElement("path", {
          d: "M12.6785 6.53574H11.3928V10.3929H12.6785V6.53574Z",
          fill: "#9146FF",
        })
      ),
      Fc = (global.React || guac.react).createElement("path", {
        d: "M18.6901 10.6478C18.5589 10.6603 18.4277 10.667 18.2965 10.6679C16.8561 10.6679 15.5125 9.94202 14.7224 8.7363V15.3127C14.7224 17.9971 12.5465 20.1739 9.86118 20.1739C7.17584 20.1739 4.99999 17.998 4.99999 15.3127C4.99999 12.6274 7.17584 10.4515 9.86118 10.4515C9.9627 10.4515 10.0623 10.4611 10.1619 10.4668V12.8629C10.0623 12.8515 9.96366 12.8323 9.86118 12.8323C8.49074 12.8323 7.38079 13.9432 7.38079 15.3127C7.38079 16.6831 8.4917 17.7931 9.86118 17.7931C11.2316 17.7931 12.4421 16.7138 12.4421 15.3433L12.4661 4.1739H14.7578C14.9743 6.22908 16.631 7.83416 18.692 7.98451V10.6469",
      }),
      jc = (global.React || guac.react).createElement(
        (global.React || guac.react).Fragment,
        null,
        (global.React || guac.react).createElement("path", {
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M7.12003 17.7986C3.81468 14.9297 5.95226 8.54288 11.0348 9.34646V9.93801C6.74251 9.73821 4.85309 14.8582 7.12003 17.7986ZM16.3907 6.7186C16.9129 7.1359 17.6331 7.44353 18.6259 7.5032V8.08271C17.5275 7.87907 16.831 7.33314 16.3907 6.7186ZM15.0124 3.66779C15.0124 3.88182 15.0394 4.11154 15.0744 4.32119H13.049V14.4091C13.049 14.874 13.0013 15.2882 12.9058 15.6515C12.0803 17.4702 9.74479 17.233 9.09832 15.9845C10.0595 16.5867 11.6397 16.4265 12.2883 14.9981C12.3829 14.6357 12.4307 14.2208 12.4307 13.7557V3.66779H15.0124Z",
          fill: "#00F7EF",
        }),
        (global.React || guac.react).createElement("path", {
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M15.63 4.3212V4.33415C15.63 4.56771 15.6991 7.94513 19.2428 8.15588C19.2428 11.2979 19.2444 8.15588 19.2444 10.7651C18.978 10.781 16.9114 10.6317 15.6252 9.48459L15.6212 14.5648C15.6531 16.8651 14.3726 19.1209 11.9752 19.5756C11.3035 19.7034 10.6979 19.7172 9.68344 19.4953C3.83489 17.7459 5.77869 9.07131 11.6508 9.99969C11.6508 12.8002 11.6524 9.99969 11.6524 12.8002C9.22564 12.4433 8.41495 14.4606 9.05959 15.9064C9.64622 17.222 12.0619 17.5074 12.9043 15.651C12.9997 15.2876 13.0474 14.8735 13.0475 14.4086V4.3212H15.63Z",
          fill: "black",
        }),
        (global.React || guac.react).createElement("path", {
          fillRule: "evenodd",
          clipRule: "evenodd",
          d: "M11.0348 9.93801C11.2414 9.94694 11.4473 9.96759 11.6515 9.99987C11.6515 12.8003 11.6532 9.99987 11.6532 12.8003C9.22637 12.4434 8.41568 14.4608 9.06032 15.9066C9.07218 15.9329 9.08496 15.9592 9.09828 15.9845C8.8098 15.8041 8.57771 15.5561 8.44268 15.2532C7.79895 13.8081 8.60964 11.79 11.0355 12.1469C11.0355 9.5802 11.0348 11.7161 11.0348 9.93801ZM18.6253 8.08198C18.8295 8.11894 19.0358 8.14332 19.243 8.15497C19.243 11.297 19.2446 8.15497 19.2446 10.7642C18.9782 10.7801 16.9116 10.6308 15.6254 9.48368L15.6214 14.5639C15.6533 16.8642 14.3728 19.12 11.9754 19.5747C11.3037 19.7024 10.6981 19.7163 9.68362 19.4944C8.54066 19.1527 7.69658 18.5456 7.11945 17.7975C7.63363 18.2444 8.27919 18.606 9.06689 18.8421C10.081 19.0631 10.6861 19.0487 11.3577 18.9215C13.7557 18.4677 15.0362 16.2112 15.0052 13.9121L15.0083 8.83118C16.2945 9.97834 18.3611 10.1285 18.6282 10.1117C18.6282 7.6884 18.6259 10.2248 18.6259 8.08198H18.6253ZM15.63 4.3212V4.33415C15.63 4.47137 15.6546 5.69096 16.3907 6.7186C15.5035 6.00881 15.1864 4.98336 15.0744 4.3212H15.63Z",
          fill: "#FF004F",
        })
      ),
      Zc = (global.React || guac.react).createElement("path", {
      ...
      Gc = (global.React || guac.react).createElement("path", {
      ...
      qc = (global.React || guac.react).createElement(
        "g",
        { fill: "#2867B2" },
        Gc
      ),
      Yc = (global.React || guac.react).createElement("path", {
        d: "M20 12.047C20 7.603 16.418 4 12 4s-8 3.603-8 8.047c0 4.017 2.925 7.346 6.75 7.95v-5.624H8.719v-2.326h2.031v-1.773c0-2.017 1.194-3.13 3.022-3.13.875 0 1.79.157 1.79.157v1.98h-1.008c-.994 0-1.304.62-1.304 1.257v1.51h2.219l-.355 2.325H13.25v5.624c3.825-.604 6.75-3.933 6.75-7.95z",
      }),
      Jc = (global.React || guac.react).createElement(
        "g",
        null,
        (global.React || guac.react).createElement("path", {
          d: "M20 12a8 8 0 10-9.25 7.903v-5.59H8.719V12h2.031v-1.762c0-2.005 1.194-3.113 3.022-3.113.875 0 1.79.156 1.79.156V9.25h-1.008c-.994 0-1.304.617-1.304 1.25V12h2.219l-.355 2.313H13.25v5.59A8.002 8.002 0 0020 12z",
          fill: "#1877F2",
        }),
        (global.React || guac.react).createElement("path", {
          d: "M15.114 14.313L15.47 12h-2.22v-1.5c0-.633.31-1.25 1.304-1.25h1.008V7.281s-.915-.156-1.79-.156c-1.828 0-3.022 1.107-3.022 3.113V12H8.719v2.313h2.031v5.59c.828.13 1.672.13 2.5 0v-5.59h1.864z",
          fill: "#fff",
        })
      ),
      Qc = (global.React || guac.react).createElement("path", {
    ...
    var Kc = {
      __proto__: null,
      pinterestMinimal: zc,
      pinterestMinimalColor: Ac,
      youtubeMinimal: Bc,
      youtubeMinimalColor: Ic,
      twitterMinimal: Vc,
      googleplusMinimal: Xc,
      houzzMinimal: Dc,
      houzzMinimalColor: Uc,
      discordMinimal: Wc,
      discordMinimalColor: Oc,
      twitchMinimal: _c,
      twitchMinimalColor: Nc,
      tiktokMinimal: Fc,
      tiktokMinimalColor: jc,
      instagramMinimal: Zc,
      instagramMinimalColor: $c,
      linkedinMinimal: Gc,
      linkedinMinimalColor: qc,
      facebookMinimal: Yc,
      facebookMinimalColor: Jc,
      yelpMinimal: Qc,
      yelpMinimalColor: (global.React || guac.react).createElement(
        "g",
        { fill: "#D32323" },
        Qc
      ),
      XINGMinimal: (global.React || guac.react).createElement("path", {
      ...
      XINGMinimalColor: (global.React || guac.react).createElement(
        "g",
        null,
        (global.React || guac.react).createElement("path", {
    ...
    function ls(e) {
      ...
      if (!t) return null;
      const g = Object.assign({}, lc, o);
      let p, u, d;
      "object" == typeof a && "width" in a && "height" in a
        ? ((u = a.width), (d = a.height))
        : (p = this.mapPropValue("iconSize", a));
      let h = !1,
        m = t;
      const b =
        Object.prototype.hasOwnProperty.call(t, "type") &&
        ("path" === t.type || "g" === t.type);
      if ("string" == typeof t) {
        if (!g[t])
          return (
            console.warn(
              `Incorrect icon name ${t} - the issue is probably in ${this.base.widgetPreset}`
            ),
            null
          );
        n && (t = g[t + "Color"] ? t + "Color" : t), (m = g[t]);
      } else if (!b)
        return console.warn("Icon prop is not a valid SVG element"), null;
      return (
        i &&
          "number" == typeof p &&
          p < l.M &&
          ((h = (l.M - p) / 2 + "px"), (p = l.M + "px")),
        this.merge(
          {
            tag: "svg",
            children: m,
            viewBox: u && d ? `0 0 ${u} ${d}` : "0 0 24 24",
            fill: c,
            width: u || p,
            height: d || p,
            style: {
    ...
    function ns(e) {
      let { animation: t, icon: r = "hamburger", ...o } = e;
      const l = { verticalAlign: "top" };
      if (t) {
        const {
          animationIcon: e,
          iconPack: r,
        ...
        return this.merge({
          ...
          children: (global.React || guac.react).createElement(
            ...
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Icon,
              a.a({ icon: e, iconPack: r, style: { ...n, ...l } }, o)
            ),
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX.Style,
              null,
      ...
      return this.Icon(this.merge({ icon: r, style: l }, o));
    }
    function is(e) {
      const t = { top: "50%", transform: "translateY(-50%)", left: 8 };
      return this.Icon(
        this.merge({ style: { "@xs-only": t, "@sm-only": t } }, e)
      );
    }
    function cs(e) {
      const t = "neutral" === this.base.category;
      return this.Icon(
        this.merge({ color: t, style: { color: "highContrast" } }, e)
      );
    }
    function ss(e) {
      let { icon: t } = e;
      return (
        ...
        (e.icon = t),
        (e.iconPack = { ...Hc, ...Kc }),
        this.Icon(this.merge({ style: { color: "highContrast" } }, e))
      );
    }
    function gs(e) {
      const t = "neutral" === this.base.category;
    ...
    function ds(e) {
      ...
      const { widgetType: g, order: p } = this.base,
        {
          ...
          if (r)
            if (r === vt)
              delete n.outputHeight,
                delete n.editedAspectRatio,
                (l.borderRadius = 0);
            else {
              const { aspectRatio: e, borderRadius: o } = Tt[r] || {};
              e && t
                ? (n.outputHeight = t / e)
                : e && a && (n.outputWidth = a * e),
                (l.borderRadius = o),
                (l.aspectRatio = e);
            }
          return {
        ...
        this.merge(
          {
            ...
            lazyLoad: n && m === es && !y && !C,
            mobileGutterWidth: i,
            reserveMobileHeight: f,
          },
          s,
          { style: h ? u : { borderRadius: s.style?.borderRadius || 0 } }
        )
      );
    }
    function hs(e) {
      return this.Image(
        this.merge({ style: { borderRadius: "50%", objectFit: "cover" } }, e)
      );
    }
    function ms(e) {
      let { hasOverhang: t, ...a } = e;
      const r = { display: "block", margin: "0 auto", maxHeight: t ? 88 : 80 };
      return this.Image(
        this.merge(
          {
            style: {
    ...
    function ys(e) {
      const t = (function (e) {
          const t = { clear: "both", maxWidth: "50%" };
          switch (e) {
            case "left":
              return Object.assign({ float: "left", marginRight: "medium" }, t);
            case "right":
              return Object.assign({ float: "right", marginLeft: "medium" }, t);
            default:
              return null;
          }
        })(e.alignment),
      ...
      return t && (r["@md"] = t), this.merge({ tag: "figure", style: r }, e);
    }
    function Cs(e) {
      return this.Text(
        this.merge(
    ...
    function vs(e) {
      ...
      function p() {
        const e = s ? n : document.getElementById(t),
          r = s ? i : document.getElementById(a),
          p = e.offsetWidth,
          u = e.getBoundingClientRect().width;
        if (p < l - 100 && r.innerText.length > 20)
          (r.style.fontSize = ""), (r.style.whiteSpace = "inherit");
        else {
          r.style.whiteSpace = "nowrap";
          const e = r.scrollWidth || 1,
            t = window.getComputedStyle(r),
            a = parseFloat(t.fontSize) || 1,
            l = u / e,
            i = (function () {
              if (!s) {
                const e = n.closest(".ux-scaled");
                if (e) {
                  const t = e.style?.transform?.match(/[0-9.]+/);
                  t && t.length > 0 && (c = parseFloat(t[0]) || 1);
                }
              }
              return c;
            })(),
            g = Math.min(o, Math.floor((a * l) / i));
          g !== a && (r.style.fontSize = `${g}px`);
        }
        n !== e && ((n = e), g.observe(n)), i !== r && ((i = r), g.observe(i));
      }
      return (
        p(),
        g.observe(n),
        g.observe(i),
        document.fonts.addEventListener("loadingdone", p),
        () => {
          (i.style.fontSize = ""),
            g.disconnect(),
            document.fonts.removeEventListener("loadingdone", p);
        }
      );
    }
    const { Bootstrap: Ps } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      {
        renderModes: { PUBLISH: ks },
        breakpoints: { SM_MIN: Ls },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      Es = (e) => {
        let {
          containerId: t,
        ...
        return (
          ...
          l
            ? (global.React || guac.react).createElement(Ps.JS, {
                id: "FullWidthScaler",
                script: vs.toString(),
                props: {
                  containerId: t,
    ...
    Es.propTypes = {
      ...
      targetId: (global.PropTypes || guac["prop-types"]).string.isRequired,
      renderMode: (global.PropTypes || guac["prop-types"]).string.isRequired,
      maxSize: (global.PropTypes || guac["prop-types"]).number,
    };
    const Rs = (global.React || guac.react).lazy(
        () =>
      ...
      { sectionTypes: Ms } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants,
      Ss = { wordWrap: "break-word", overflowWrap: "break-word" };
    function Hs(e) {
      let {
        children: t,
        tag: a,
      ...
      const { widgetType: c, widgetId: s, renderMode: g, order: p } = this.base,
        u = this.mapPropValue("lineHeightLevel", r),
        d = o ? { originalText: t } : {},
        h = "undefined" != typeof window && "PUBLISH" === g;
      let m = a ? parseInt(a.substring(1), 10) : r,
        b = !1;
      const y = Ts({ tag: a, level: r });
      if (
        this.prevWidgetId !== s &&
        m &&
        1 !== m &&
        ...
        if (h) {
          ...
          (!e ||
            (e.getAttribute("data-promoted-from") === `${m}` &&
              e.getAttribute("data-order") === `${p}`)) &&
            (b = !0);
        } else b = !0;
      b && ((i["data-promoted-from"] = m), (i["data-order"] = p), (m = 1)),
        (this.prevWidgetId = s),
        (this.hasH1 = this.hasH1 || 1 === m);
      const C =
        !i.richtext && "string" == typeof t && t.includes("\n")
          ? "pre-line"
          : void 0;
      if (i.dangerouslySetInnerHTML) {
        const { __html: e } = i.dangerouslySetInnerHTML;
        i.dangerouslySetInnerHTML = { __html: l ? `<${l}>${e}</${l}>` : e };
      } else
        i.children =
          t && l ? (global.React || guac.react).createElement(l, null, t) : t;
      const f = m ? `h${m}` : a;
      return this.merge(
        {
          tag: i.richtext
            ? (e) =>
                (global.React || guac.react).createElement(
                  ...
                  (global.React || guac.react).createElement(Rs, e)
                )
            : f,
          typography: {
            1: "HeadingAlpha",
          ...
          richTextContainer: i.richtext && f,
          featured: Boolean({ 5: !0, 6: !0 }[y]),
          role: "heading",
          "aria-level": m,
          style: {
            ...Ss,
        ...
        (global._ || guac.lodash).omit(i, ["layout", "tag", "font"])
      );
    }
    function zs(e) {
      return this.Heading(
        this.merge({ tag: "h2", typography: "HeadingBeta" }, e)
      );
    }
    function As(e) {
      return this.Heading(
        this.merge({ tag: "h3", typography: "HeadingGamma" }, e)
      );
    }
    function Bs(e) {
      return this.Heading(
        this.merge({ tag: "h4", typography: "HeadingDelta" }, e)
      );
    }
    function Is(e) {
      return this.HeadingMinor(this.merge({ featured: !0 }, e));
    }
    function Vs(e) {
      let t,
        {
      ...
      "string" == typeof c &&
        (!g.richtext && c.includes("\n") && (t = "pre-line"),
        r
          ? (c = (global.Core || guac["@wsb/guac-widget-core"]).utils.linkify(
              c,
              { linkStyle: o, phoneProps: l, urlProps: n, emailProps: i }
            ))
          : a &&
            (g.dangerouslySetInnerHTML = {
              __html: c.replace(/\s(?=[^\s]*$)/, "&nbsp;"),
            })),
        g.dangerouslySetInnerHTML || (g.children = c),
        "h1" === s && (this.hasH1 = !0);
      return this.merge(
        {
          tag: g.richtext
    ...
    function Xs(e) {
      return this.Text(
        this.merge({ typography: "BodyBeta" }, e, {
          style: {
            textShadow: this.base.section === Ms.OVERLAY ? l.O : "none",
          },
        })
      );
    }
    ...
    function Us(e) {
      return this.Text(this.merge({ typography: "DetailsAlpha" }, e));
    }
    function Ws(e) {
      return this.Details(this.merge({ typography: "DetailsBeta" }, e));
    }
    function Os(e) {
      let { priceState: t = "featured", ...a } = e;
      return this.Text(
        this.merge({ tag: "div", typography: "BodyAlpha", [t]: !0 }, a)
      );
    }
    function _s(e) {
      return this.Price(this.merge({ typography: "BodyBeta" }, e));
    }
    function Ns(e) {
    ...
    function Zs(e) {
      return this.Details(this.merge({ typography: "DetailsAlpha" }, e));
    }
    function $s(e) {
      return this.Text(
        this.merge({ typography: "BodyAlpha", featured: !0 }, e)
      );
    }
    function Gs(e) {
      let { wrapped: t, fontSizes: a, ...r } = e;
      const {
          maxLines: o,
          style: l,
          typography: n = "HeadingAlpha",
          children: i,
          id: c,
          containerId: s,
          allowFullWidth: g,
        ...
        { renderMode: h } = d,
        m = g && u;
      if ("HEADER" !== this.base.widgetType || t || "scaler" === r["data-ux"])
      ...
      const b = {
        ...
        y = this.merge(
          { maxWidth: "100%", whiteSpace: "pre-line", display: "inline-block" },
          l,
          m
            ? {
                lineHeight: "1.1",
        ...
        C = m
          ? (global.React || guac.react).createElement(Es, {
              containerId: s,
              targetId: c,
              renderMode: h,
            })
          : (global.React || guac.react).createElement(p.default, {
              renderMode: h,
              font: "primary",
              text: i,
              containerId: s,
      ...
      return this.Block(
        this.merge(
          ...
          (global._ || guac.lodash).omitBy(d, (e, t) => t.startsWith("data-")),
          { tag: "div" }
        )
      );
    }
    function qs(e) {
      return this.Text(this.merge({ typography: "BodyBeta", featured: !0 }, e));
    }
    function Ys(e) {
      return this.Heading(
        this.merge({ tag: "h2", typography: "BodyBeta", featured: !0 }, e)
      );
    }
    function Js(e) {
      return this.Text(e);
    ...
    function Qs(e) {
      return this.Heading(
        this.merge({ level: 3, typography: "HeadingGamma" }, e)
      );
    }
    function Ks(e) {
      return this.Heading(
        this.merge({ level: 3, typography: "BodyAlpha", featured: !0 }, e)
      );
    }
    function eg(e) {
      return this.Text(
    ...
    function tg(e) {
      let { treatment: t, ...a } = e;
      const o = { a: { textDecoration: "none" } };
      return (
        t === r.d && (o.fontSize = "large"),
        this.Text(
          this.merge({ typography: "BodyBeta", featured: !0, style: o }, a)
        )
      );
    }
    function ag(e) {
      return this.Phone(
        this.merge(
          {
            ...(Ur(this.base) && { typography: "BodyAlpha" }),
            style: { "@md": { marginBottom: 0 } },
          },
          e
        )
      );
    ...
    function sg(e, t) {
      return cg(e, "colorDial", t);
    }
    function gg(e, t) {
      return cg(e, "color", t);
    }
    function pg(e, t) {
      return cg(e, "backgroundColor", t);
    }
    function ug(e, t) {
      return cg(e, "borderColor", t);
    }
    const { Color: dg } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
        .utils,
      hg = new dg("rgba(255,255,255,1)"),
      mg = new dg("rgba(0,0,0,1)"),
      bg = new dg("rgba(69,90,100,1)"),
      yg = new dg("#ff0000"),
      Cg = new dg("rgba(0, 0, 0, 0.3)"),
      fg = new dg("rgba(255, 255, 255, 0.3)"),
      { Color: xg } = (global.Core || guac["@wsb/guac-widget-core"]).UX2.utils,
      wg = {},
      Tg = (e, t) =>
        Math.pow(e.saturation - t.saturation, 2) +
        Math.pow(e.value - t.value, 2),
      vg = 0.02;
    function Pg(e) {
      let {
        threshold: t,
      ...
      for (let e = l; e <= 100; e++) {
        const l = xg.contrastRatio(a, xg.hsvToRgb(r, o, e));
        if (n && l < t + vg) return e - 1;
        if (!n && l >= t + vg) return e;
      }
    }
    function kg(e, t, a) {
      let r =
        arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1;
      if (xg.contrastRatio(a, t) >= e + vg) return [a];
      const [o, l, n] = a.toHsv(),
        i = (function (e, t, a, r) {
          ...
          if (!(o in wg)) {
            const l = [],
              ...
              c = Pg({
                ...
                saturation: 0,
                initialValue: 0,
                isCurrentValueAccessible: xg.contrastRatio(i, n) >= e + vg,
              });
      ...
      return i
        .map((e, t) => ({
          ...
          value: e,
          distance: Tg(
            { saturation: t, value: e },
            { saturation: l, value: n }
          ),
        }))
        .sort((e, t) => e.distance - t.distance)
        .slice(0, r)
        .map((e) => xg.fromHSV(o, e.saturation, e.value));
    }
    const { Color: Lg, accessibility: Eg } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).UX2.utils,
      { PRIMARY: Rg } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .categoryTypes,
      { DEFAULT_WEBSITE_FONT_SCALES: Mg } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).constants.fontScales,
      { OVERLAY: Sg } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .sectionTypes,
      { AA: Hg } = (global.Core || guac["@wsb/guac-widget-core"]).constants
    ...
    function zg() {
      const {
        ...
        o = Xe.call(this, e, r) * Mg[a],
        l = cg(this, "fontDial", `${t}.weight`);
      return Eg.textContrastThresholds(o, l)[Hg];
    }
    function Ag(e) {
      const t = sg(this, "background"),
        a = zg.call(this);
      if (Lg.contrastRatio(e, t) < a) {
        const r = (global._ || guac.lodash).first(kg(a, t, e));
        if (r) return r;
      }
      return e;
    }
    function Bg(e, t) {
      let a =
        arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 55;
      return !(!e && !t) && Math.abs(e.lightness - t.lightness) <= a;
    }
    var Ig = {
      __proto__: null,
      colorSection: function () {
        const [e, t] = sg(this, ["background", "multiplier"]);
        return e.setAlpha(100).contrast(60 * t);
      },
      colorBackground: function () {
        return sg(this, "background");
      },
      colorError: function () {
        const [e, t, a] = sg(this, ["background", "multiplier", "error"]);
        return a.contrastWith(e, 50 * t, !0);
      },
      colorPrimary: function () {
        const [e, t, a] = sg(this, ["primary", "background", "multiplier"]);
        return e.contrastWith(t, 40 * a, !0);
      },
      colorAccent: function () {
        const [e, t, a] = sg(this, ["accent", "background", "multiplier"]);
        return e.contrastWith(t, 40 * a, !0);
      },
      colorNeutral: function () {
        const [e, t, a] = sg(this, ["neutral", "background", "multiplier"]);
        return e.contrastWith(t, 40 * a, !0);
      },
      colorPrimaryOverlay: function () {
        const [e, t] = sg(this, ["primary", "background"]),
      ...
      colorHighlightHover: function () {
        const [e, t, a, r] = sg(this, [
          ...
          { section: o } = this.base;
        if (o === Sg) return r.contrastWith(e, 40 * t, !0);
      ...
      colorHighlightActive: function () {
        const [e, t, a] = sg(this, ["background", "multiplier", "highlight"]);
        return a.contrastWith(e, 80 * t, !0);
      },
      colorHighlightDisabled: function () {
        return gg(this, "highlight").setAlpha(70);
      },
      colorAction: function () {
        const e = pg(this, "action"),
          t = sg(this, "multiplier");
        return e.contrast(80 * t);
      },
      colorActionHover: function () {
        return gg(this, "action");
      },
      colorActionActive: function () {
        return gg(this, "action");
      },
      colorActionDisabled: function () {
        return gg(this, "action").setAlpha(70);
      },
      colorActionContrast: function () {
        const e = pg(this, "actionContrast"),
          t = sg(this, "multiplier");
        return e.contrast(100 * t);
      },
      colorActionContrastHover: function () {
        return gg(this, "actionContrast");
      },
      colorActionContrastActive: function () {
        return gg(this, "actionContrast");
      },
      colorActionContrastDisabled: function () {
        return gg(this, "actionContrast").setAlpha(70);
      },
      colorInput: function () {
        const e = pg(this, "input"),
          t = sg(this, "multiplier");
        return e.setAlpha(100).contrast(70 * t);
      },
      colorInputHover: function () {
        return gg(this, "input");
      },
      colorInputActive: function () {
        return gg(this, "input");
      },
      colorInputDisabled: function () {
        return gg(this, "input").setAlpha(70);
      },
      colorInputPlaceholder: function () {
        return gg(this, "inputDisabled");
      },
      colorInputHighlight: function () {
        const e = pg(this, "input"),
          t = sg(this, "multiplier");
        return gg(this, "highlight").contrastWith(e, 30 * t, !0);
      },
      colorLightnessSimilarity: Bg,
      colorBrandLividContrast: function () {
        return pg(this, "brandLivid").lightness > 50 ? mg : hg;
      },
    };
    const { Color: Vg } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
        .utils,
      { categoryTypes: Xg, sectionTypes: Dg } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).constants;
    var Ug = {
      __proto__: null,
      ...
      colorDialBackground: function () {
        ...
        if (e === Xg.PRIMARY) {
          ...
          return t === Dg.OVERLAY ? a.setAlpha(50) : a;
        }
        return e === Xg.ACCENT
          ? t === Dg.ALT
            ? a.darken(8)
      ...
      colorDialOutline: function () {
        const e = sg(this, "background");
        return e.lightness > 90 && e.alpha > 80;
      },
      colorDialMultiplier: function () {
        return (100 - sg(this, "background").alpha) / 50 + 1;
      },
      colorDialError: function () {
        return yg;
      },
    };
    const { Color: Wg } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
      .utils;
    var Og = {
      __proto__: null,
      ...
      backgroundColorSectionOverlaySoft: function () {
        return sg(this, "background").setAlpha(25);
      },
      ...
      backgroundColorNeutral: function () {
        return sg(this, "neutral");
      },
      backgroundColorNeutralOverlay: function () {
        const [e, t] = sg(this, ["neutral", "background"]),
          a = 100 === t.alpha ? 90 : 90 === t.alpha ? 50 : 30;
        return e.setAlpha(a);
      },
      backgroundColorAccentOverlay: function () {
        const [e] = sg(this, ["background"]),
          t = 100 === e.alpha ? 90 : 90 === e.alpha ? 50 : 30;
        return mg.setAlpha(t);
      },
      backgroundColorPrimary: function () {
        return sg(this, "primary");
      },
      backgroundColorPrimaryLight: function () {
        return sg(this, "primary").setLightness(96).setAlpha(100);
      },
      ...
      backgroundColorModalOverlay: function () {
        return mg.setAlpha(60);
      },
      backgroundColorAccent: function () {
        return sg(this, "accent");
      },
      backgroundColorAction: function () {
        const [e, t, a] = sg(this, ["highlight", "background", "multiplier"]);
      ...
      backgroundColorActionDisabled: function () {
        return pg(this, "action").setAlpha(70);
      },
    ...
    var jg = {
        ...
        borderColorSection: function () {
          ...
          return e.alpha < 100
            ? e.isLight()
              ? Cg
              : fg
            : e.contrast(10 * sg(this, "multiplier"), !0);
        },
        ...
        borderColorInput: function () {
          const [e, t] = sg(this, ["outline", "background"]);
          return e
            ? pg(this, "input").contrastWith(t, 10 * sg(this, "multiplier"), !0)
            : t.setAlpha(100).setLightness(t.isDark() ? 100 : 0);
        },
        borderColorInputDisabled: function () {
          return ug(this, "input").setAlpha(70);
        },
        borderColorInputError: function () {
          const [e, t, a] = sg(this, ["error", "background", "multiplier"]);
        ...
        borderColorHighlightDisabled: function () {
          return ug(this, "highlight").setAlpha(70);
        },
    ...
    const $g = {
        ...
        headerTreatmentsConfig: {
          headerTreatments: [r.F, r.b, r.c, r.B],
          ...
          (global._ || guac.lodash).reduce(
            ...
            (e, a, l) => {
              if ((global._ || guac.lodash).startsWith(l, "@"))
                e[l] = Yg({ fontSizeMap: a, children: r });
              else {
                let n;
                "string" == typeof r && t && (n = o.c(r)),
                  (n = n || (global._ || guac.lodash).get(r, "length", 0));
    ...
    function Jg(e, t) {
      return (global._ || guac.lodash).merge(
        {},
        qg.call(this, this.mappedValues.typographyMapping[e], t),
        {
          ...(t?.style?.fontSize
            ? { style: { fontSize: t.style.fontSize } }
            : {}),
        },
        qg.call(this, this.mappedValues.typographyOverrides?.[e], t) || {},
        qg.call(this, this.mappedValues[`typography${e}`], t) || {},
        t.fontSizeMap
          ? (function (e) {
              return { style: Yg(e) };
            })(t)
      ...
      return (
        (e &&
          (t.typography && t.typography.toLowerCase()) !==
            (e && e.toLowerCase()) &&
          Jg.call(this, t.typography, t)[e.toLowerCase()]) ||
        a
      );
    }
    function Kg(e, t) {
      return e
        ? e
            ...
            .reduce(
              (e, a) =>
                (global._ || guac.lodash).merge({}, e, Jg.call(this, a, t)),
              {}
            )
        : {};
    }
    const ep = {
      ...
      tp = ["Active", "Featured", "Disabled", "Alert", "Expired"],
      ap = {
        style: {
          font: "primary",
          color: "highContrast",
    ...
    class rp extends (global.Core || guac["@wsb/guac-widget-core"]).UX2.Theme {
      constructor() {
        var e;
        super(),
          (e = this),
            ...
            typographyMapping: {
              ...
              LinkAlpha: {
                style: {
                  ...
                  letterSpacing: "inherit",
                  textTransform: "inherit",
                  ":hover": { color: "highlightHover" },
                  ":active": { color: "highlightActive" },
                },
              },
              NavAlpha: {
                style: {
              ...
              NavGamma: {
                ...
                active: { style: { color: "highlight", fontWeight: "bold" } },
              },
              SubNavGamma: (e) =>
                (global._ || guac.lodash).merge(Jg.call(this, "NavGamma", e), {
                  style: { color: "section" },
                }),
              ButtonAlpha: (e) => {
              ...
              Featured: (e) =>
                Qg.call(this, "featured", e, {
                  style: { color: "highContrast" },
                }),
              Alert: (e) =>
                Qg.call(this, "alert", e, { style: { color: "error" } }),
              Disabled: (e) => {
                const t = {
                  style: {
                    color: "inputDisabled",
                    ":hover": { color: "inputDisabled" },
                  },
                };
                return Qg.call(this, "disabled", e, t);
              },
              Expired: (e) => {
                const t = {
                  style: {
                ...
                return Qg.call(this, "expired", e, t);
              },
              Active: (e) =>
                Qg.call(this, "active", e, { style: { fontWeight: "bold" } }),
            },
            typography: (t) =>
              function () {
                let a =
      ...
      static getWidgetDefaultProps(e) {
        return {
          alignmentOption: "center",
          ...("HEADER" === e && { logo: { logoAlign: "left" } }),
        };
      }
      static getMutatorDefaultProps(e) {
        return "HEADER" === e ? $g : Gg;
      }
      getButtonDefaults() {
        const e =
    ...
    a._(rp, "excludedProps", [
      ...
      (t.c = Bg),
      (t.d = function (e) {
        let { styleOverrides: t, otherStyleOverrides: a, renderMode: r } = e;
        const o = {
          display: "inline",
