define(
  "@widget/LAYOUT/c/bs-Toggle-37f740c7.js",
    ...
    class l extends (global.React || guac.react).Component {
      constructor() {
        super(...arguments),
          ...
          (this._id = (global._ || guac.lodash).uniqueId()),
          (this.state = { open: !1 });
      }
      componentDidMount() {
        (this._link = (global.ReactDOM || guac["react-dom"]).findDOMNode(this)),
          document.addEventListener("click", this.handleClick, { capture: !0 });
      }
      ...
      shouldClose(e) {
        ...
        let a = !0;
        return (
          t ? (a = o(e.target, t)) : l && (a = !o(e.target, l)),
          !a && i && n && (a = !s(e.target, i)),
          a && !s(e.target, this._id)
        );
      }
      handleClick(e) {
        const { open: t } = this.state;
        t && this.shouldClose(e) && this.setState({ open: !1 });
      }
      handleToggle(e) {
        e.preventDefault(),
          e.stopPropagation(),
      ...
      render() {
        const e = (global._ || guac.lodash).omit(this.props, [
          ...
          { open: o } = this.state,
          { style: s, activeStyle: l, isActive: n } = this.props,
          i = { ...(n ? { ...l } : { ...s }) },
          a = n
