define(
  "@wsb/guac-widget-shared/lib/components/Carousel-7574d33c.js",
  [
    "exports",
      ...
      m = function (e, t) {
        ...
        if ("number" === n && isFinite(e))
          return t.long
            ? (function (e) {
                var t = Math.abs(e);
                if (t >= h) return g(e, t, h, "day");
                if (t >= c) return g(e, t, c, "hour");
                if (t >= u) return g(e, t, u, "minute");
                if (t >= d) return g(e, t, d, "second");
                return e + " ms";
              })(e)
            : (function (e) {
                var t = Math.abs(e);
    ...
    var b = n.c(function (e, t) {
        ...
        class l extends n.Component {
          static get propTypes() {
            return {
              numSlides: o.default.number.isRequired,
              selectedIndex: o.default.number.isRequired,
              goToSlide: o.default.func.isRequired,
            };
          }
          render() {
            const { numSlides: e, selectedIndex: t, goToSlide: i } = this.props,
              r = [];
            for (let o = 0; o < e; o++) {
              const e = (0, a.default)("carousel-dot", { selected: o === t });
              r.push(
                n.default.createElement(
                  ...
                  n.default.createElement(
                    "button",
                    { className: e, onClick: i.bind(null, o) },
                    "•"
                  )
                )
              );
        ...
        class a extends n.Component {
          static get propTypes() {
            return {
              numSlides: o.default.number.isRequired,
              selectedIndex: o.default.number.isRequired,
              infinite: o.default.bool.isRequired,
              prevSlide: o.default.func.isRequired,
              nextSlide: o.default.func.isRequired,
              direction: o.default.oneOf(["left", "right", "top", "bottom"])
                .isRequired,
              arrows: o.default.oneOfType([
                o.default.bool,
                o.default.shape({
                  left: o.default.node.isRequired,
                  right: o.default.node.isRequired,
          ...
          hasNext() {
            ...
            return t || (["top", "left"].includes(e) ? i > 0 : i < n - 1);
          }
          render() {
            const {
              prevSlide: e,
            ...
            let o = null,
              s = "carousel-arrow-default";
            return (
              r.left &&
                ((s = r.className ? r.className : ""),
                (o = "left" === i ? r.left : r.right)),
              n.default.createElement(
                "button",
                {
                  type: "button",
                  disabled: !this.hasNext(),
                  onClick: ["top", "left"].includes(i) ? e : t,
                  className: `carousel-arrow carousel-${i}-arrow ${s}`,
                },
                o
              )
            );
      ...
      T = n.c(function (e, t) {
        ...
        var n = i.i(a),
          ...
          f = i.i(S),
          p = i.i(_);
        const g = "carousel-slide-selected",
        ...
        class w extends d.Component {
          static get propTypes() {
            return {
              ...
              transition: u.default.oneOf(["slide", "fade", "none"]),
              dots: u.default.bool,
          ...
          constructor(e) {
            super(...arguments),
              (0, o.default)(this, "handleInitialLoad", () => {
              ...
              (0, o.default)(this, "goToSlide", (e, t, n = !1) => {
                const {
                    beforeChange: i,
                    transitionDuration: r,
                    transition: o,
                    onSlideTransitioned: s,
                    children: a,
                  } = this.props,
                ...
                (t = t || (e > l ? "right" : "left")),
                  s && s({ autoPlay: n, index: c, direction: t }),
                  l !== c &&
                    (this._animating ||
                      ((this._animating = !0),
                      i && i(c, l, t),
              ...
              (0, o.default)(this, "calcLeftOffset", (e = 0) => {
                const { direction: t, loading: n } = this.state,
                  { isVertical: i } = this.props,
                  r =
                    this._viewport &&
                    (i
                      ? this._viewport.offsetHeight
                      : this._viewport.offsetWidth);
                if ((clearTimeout(this._retryTimer), !this._track || !r))
                ...
                let { currentSlide: u } = this.state;
                const c = this._track.childNodes,
                  h = d.Children.count(s);
                o &&
                  (0 === u && "right" === t
                    ? (u = h)
                    : u === h - 1 && "left" === t && (u = -1));
                ...
                for (
                  ...
                  ((f = c[e]),
                  (m -= a),
                  (v = -1 !== f.className.indexOf(b)),
                  (p = i ? f.offsetHeight : f.offsetWidth),
                  (g = g || (!p && !v)),
                  parseInt(f.getAttribute("data-index"), 10) !== u);
                  e++
                )
                  m -= p;
                "center" === l
                  ...
                  : "right" === l && (m += r - p);
                const y = g && e < 500;
                m !== this.state.leftOffset && this.setState({ leftOffset: m }),
                  y
              ...
              (0, o.default)(this, "handleSlideClick", (e) => {
              ...
              (0, o.default)(this, "onMouseDown", (e) => {
              ...
              (0, o.default)(this, "onMouseMove", (e) => {
                e.preventDefault(),
                  this.setState({ dragOffset: e.clientX - this._startPos.x });
              }),
              (0, o.default)(this, "onMouseEnter", () => {
                document.addEventListener("mousemove", this.handleMovement, !1);
              }),
              (0, o.default)(this, "handleMovement", () => {
                this.setHoverState(!0);
              }),
              (0, o.default)(this, "onMouseOver", () => {
                this.setHoverState(!0);
              }),
              (0, o.default)(this, "onMouseLeave", () => {
              ...
              (0, o.default)(this, "onTouchStart", (e) => {
                const { draggable: t, transition: n } = this.props;
                t &&
                  "slide" === n &&
                  !this._animating &&
              ...
              (0, o.default)(this, "stopDragging", () => {
                const { dragThreshold: e, transitionDuration: t } = this.props,
                  ...
                  r = Math.abs(n / i),
                  o = Date.now() - this._startPos.startTime || 1,
                  s = o / (r * i),
                  a = r > 0.05 && o < 250;
                let l;
                (l =
                  ...
                  this.setState({ transitionDuration: l }, () => {
                    const { children: t, infinite: i } = this.props,
                      { currentSlide: o } = this.state,
                      s = d.Children.count(t);
                    let l = o,
                      u = "";
                    (r > e || a) &&
                      (n > 0
          ...
          getControls() {
            ...
            let r = n.slice(0);
            return (
              t && r.push({ component: x.Dots }),
              e &&
                (r = r.concat([
                  {
                    ...(i
                      ? { component: x.Arrow, props: { direction: "top" } }
                      : { component: x.Arrow, props: { direction: "left" } }),
                  },
                  {
                    ...(i
                      ? { component: x.Arrow, props: { direction: "bottom" } }
                      : { component: x.Arrow, props: { direction: "right" } }),
                  },
                ])),
              r
            );
          ...
          render() {
            const {
              ...
              M = d.Children.count(l),
              O = (0, h.default)("carousel", e, { loaded: !w }),
              E = { ...(p.container || {}), width: r, height: o },
              k = {
                ...(p.containerInner || {}),
                width: r,
                height: o,
                marginBottom: s ? "20px" : 0,
                ...(b && { display: "flex" }),
              },
              D = { ...(p.viewport || {}), width: t, height: i || u || "auto" },
              L = "rtl" === y;
            let P = { ...p.track };
            if ("slide" === f) {
              const e = T + S;
              P = {
                ...P,
                ...(b && { transform: `translateY(${L ? -e : e}px)` }),
                ...(!b && { transform: `translateX(${L ? -e : e}px)` }),
                transition: x
                  ? `transform ${(0, c.default)("" + x)}ms ${g}`
                  : "none",
              };
            }
            m || (P.touchAction = "auto");
            ...
            return d.default.createElement(
              ...
              d.default.createElement(
                "div",
                { className: "carousel-container-inner", style: k },
                I.filter((e) => "top" === e.position).map((e, t) =>
                  d.default.createElement(
                    e.component,
                    (0, n.default)({}, e.props, {
                      key: `control-${t}`,
          ...
          renderSlides() {
            ...
            let y = d.Children.map(e, (e, t) => {
              const y = `slide-${t}`,
                w = e.props.src,
                x = (0, h.default)("carousel-slide", {
                  [g]: t === m,
                  "carousel-slide-fade": "fade" === o || "none" === o,
                });
              let S = {
                ...(!f && { marginLeft: `${n}px` }),
                ...(f && { marginTop: `${n}px` }),
              ...
              "fade" === o
                ? (S.transition = `opacity ${(0, c.default)("" + s)}ms ${l}`)
                : "none" === o && (S.transition = "none"),
              ...
              const _ = {
                ...
                T = this.getIndicesToRender();
              if (!u || (w ? v[w] : T.indexOf(t) > -1)) {
                if (w && v[w]) {
                  const { width: e, height: t } = v[w];
          ...
          getIndicesToRender() {
            ...
            const a = Math.max(1, r),
              ...
              u = Math.floor(a / 2);
            let c = s(e - l, e + u);
            return null !== t && (c = c.concat(s(t - l, t + u))), c;
          }
          addClones(e) {
            const t = e.length,
              n = [
              ...
              i = [
                (0, d.cloneElement)(n[0], {
                  key: "clone-1",
                  "data-index": -2,
                  className: n[0].props.className.replace(g, ""),
                }),
                (0, d.cloneElement)(n[1], {
                  key: "clone-0",
                  "data-index": -1,
                  className: n[1].props.className.replace(g, ""),
                }),
              ],
              r = [
                (0, d.cloneElement)(n[2], {
                  key: "clone-2",
                  "data-index": t,
                  className: n[2].props.className.replace(g, ""),
                }),
                (0, d.cloneElement)(n[3], {
                  key: "clone-3",
                  "data-index": t + 1,
                  className: n[3].props.className.replace(g, ""),
                }),
              ];
