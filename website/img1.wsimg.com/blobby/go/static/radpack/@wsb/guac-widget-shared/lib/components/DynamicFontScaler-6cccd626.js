define(
  "@wsb/guac-widget-shared/lib/components/DynamicFontScaler-6cccd626.js",
  ["exports", "~/c/_rollupPluginBabelHelpers", "~/c/dynamicFontScaler"],
  function (t, e, n) {
    "use strict";
    function o(t) {
      let e,
          ...
          (a.style.width = "100%"),
            t.forEach((t) => {
              (t.style.display = "inline-block"),
                (t.style.maxWidth = `${a.clientWidth}px`);
            });
          const n = d(t);
          !(function (t) {
            t.forEach((t) => {
    ...
    const { Bootstrap: r } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      {
        XXLARGE: i,
        XLARGE: s,
      ...
      { PUBLISH: c } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .renderModes;
    class l extends (global.React || guac.react).Component {
      getDynamicFontScaler() {
        return n.d({ ...this.props });
      }
      componentDidUpdate() {
        this.invokeScript();
      }
      ...
      invokeScript() {
        const { scriptOnly: t, renderMode: e } = this.props;
        (t && e === c) ||
          (this.detachScript(),
          (this._detachScript = o(this.getDynamicFontScaler().scriptProps)));
      }
      detachScript() {
      ...
      render() {
        const { renderMode: t, scriptOnly: e } = this.props;
        if (e)
          return t === c
            ? (global.React || guac.react).createElement(r.JS, {
                id: "DynamicFontScaler",
                script: o.toString(),
                scriptOnly: !0,
              })
            : ((window.wsb = window.wsb || {}),
              (window.wsb.DynamicFontScaler =
                window.wsb.DynamicFontScaler || o),
              null);
        const { element: n, scriptProps: i } = this.getDynamicFontScaler();
        return t === c
    ...
    e.a(l, "propTypes", {
      ...
      fontSizes: (global.PropTypes || guac["prop-types"]).arrayOf(
        (global.PropTypes || guac["prop-types"]).oneOf(
          Object.values(
            (global.Core || guac["@wsb/guac-widget-core"]).constants.fontSizes
          )
        )
      ...
      scriptOnly: (global.PropTypes || guac["prop-types"]).bool,
    }),
      e.a(l, "defaultProps", { fontSizes: [i, s, a], scriptOnly: !1 }),
      (t.default = l),
