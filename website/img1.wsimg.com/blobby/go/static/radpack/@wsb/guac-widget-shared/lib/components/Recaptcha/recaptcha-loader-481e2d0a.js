define(
  "@wsb/guac-widget-shared/lib/components/Recaptcha/recaptcha-loader-481e2d0a.js",
  ["exports", "~/c/_rollupPluginBabelHelpers"],
  function (e, t) {
    "use strict";
    const s = "https://www.google.com/recaptcha/api.js",
      o = "recaptcha-script",
      c = () => ({
        siteKey: null,
        siteKeyRequested: !1,
    ...
    function a() {
      (window.wsb && window.wsb.recaptcha) ||
        ((window.wsb = window.wsb || {}), (window.wsb.recaptcha = c()));
    }
    function n(e, t) {
      a();
      const { recaptcha: s } = window.wsb;
      ...
      o.open("GET", e),
        ...
        (o.onreadystatechange = () =>
          (function (e) {
            if (
              4 !== e.readyState ||
              !(global._ || guac.lodash).includes([200, 304], e.status)
            )
              return;
            const t = JSON.parse(e.responseText),
              { recaptcha: s } = window.wsb,
    ...
    function r(e, t) {
      let { siteKey: c } = e;
      var n;
      (a(), void 0 !== window.grecaptcha && window.grecaptcha.execute)
        ? t()
        : ((n = t),
          window.wsb.recaptcha.scriptCallbacks.push(n),
          document.querySelector(`#${o}`) ||
            (function (e) {
              const t = document.createElement("script");
              t.setAttribute("src", `${s}?render=${encodeURIComponent(e)}`),
                t.setAttribute("id", o),
                t.setAttribute("async", !0),
                t.setAttribute("defer", !0),
                (t.onload = i),
    ...
    class p extends (global.React || guac.react).Component {
      ...
      componentDidMount() {
        (this.execute = this.props.onComplete),
          this.props.formSubmitHost && n(this.siteKeyUrl, this.loadRecaptcha);
      }
      get siteKeyUrl() {
    ...
    (p.propTypes = {
      ...
      (p.defaultProps = { formSubmitEndpoint: "/v3/recaptcha" }),
      (e.default = p),
